...
BEGIN
  ...
  INSERT INTO profiles (id, username, display_name, bio, role, primary_platform) VALUES
    (u_strat_dad, 'strat_dad_42', 'strat_dad_42', 'just a dad with a strat and a dream. 90s alt rock mostly', 'free', 'boss-katana'),
    ...
    (u_djent, 'djent_machine', 'djent_machine', '8 string. drop F. neural dsp. fight me', 'free', 'quad-cortex'),
    ...
    (u_bedroom, 'bedroom_shredder', 'bedroom_shredder', '16yo learning guitar. this site is sick btw', 'free', 'boss-katana'),
    ...
    (u_pick_scraper, 'pick_scraper', 'pick_scraper', 'pantera ruined me for all other music', 'free', 'quad-cortex'),
    ...
    (u_drop_d, 'drop_d_dan', 'drop_d_dan', 'drop D is the peoples tuning', 'free', 'boss-katana'),
    ...
    (u_trem_tim, 'trem_picker_tim', 'trem_picker_tim', 'surf rock and spaghetti westerns. tremolo is underrated', 'free', 'boss-katana'),
    ...
    (u_noise_nancy, 'noise_gate_nancy', 'noise_gate_nancy', 'high gain needs a good gate. ISP decimator gang', 'free', 'quad-cortex'),
