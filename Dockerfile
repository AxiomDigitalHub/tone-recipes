...
# Google OAuth client ID (public by design — it appears in every OAuth URL).
# Enables the branded in-page Google sign-in (GIS + signInWithIdToken); when
# unset the UI falls back to the Supabase redirect flow.
