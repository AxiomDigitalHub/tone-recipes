...
| 195 | Restless and Wild (solo) | Accept | Wolf Hoffmann | Restless and Wild (1982) | Stratocaster → Marshall Super Lead, Dallas Rangemaster treble booster (CORRECTED 2026-08-19 — NOT an MXR Distortion+; see #194) boost (Note 2026-08-19: DEFERRED one run for tonal variety -- #194 ships the same guitarist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | queued |
| 196 | Balls to the Wall (riff) | Accept | Wolf Hoffmann | Balls to the Wall (1983) | Fender Strat → Marshall stack, Dallas Rangemaster treble booster (CORRECTED 2026-08-19 — NOT an MXR Distortion+; see #194), mid-heavy grind (Note 2026-08-19: DEFERRED one run for tonal variety -- #194 ships the same guitarist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | queued |
...
| 198 | The Lightning to the Nations (riff) | Diamond Head | Brian Tatler | Lightning to the Nations (1980) | Gibson Flying V → Marshall JMP, Morley Power Wah Boost (Note 2026-08-19: DEFERRED one run for tonal variety -- #197 ships the same guitarist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | queued |
