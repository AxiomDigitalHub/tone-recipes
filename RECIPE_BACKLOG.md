...
| 100 | Sinner (riff) | Drowning Pool | C.J. Pierce | Sinner (2001) | DEFERRED 2026-06-19 — buildable (same album/rig as Bodies: Drop C, Mesa Dual Rectifier, Ocean/Baumgardner), held back to avoid shipping two same-album Drowning Pool recipes in one batch. Promote next run. | queued |
