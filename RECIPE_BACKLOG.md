...
| 163 | - Fu Manchu: Scott Hill uses a Univox Super-Fuzz into a Marshall JCM800, Bob Balch a Marshall Super Bass/DSL100H with Creepy Fingers fuzz — documented, but I didn't have a clean song-to-album gear pin, so I left them out rather than guess. Easy add if you want: "Hung Up in Heaven | Fu Manchu | Scott Hill / Bob Balch | California Crossing (2001) | (research note row, not a recipe -- malformed by a prior run. Reclassified 2026-08-26 to stop it sitting at the top of the queue, same convention as #105/#106. Content preserved: Fu Manchu -- Scott Hill uses a Univox Super-Fuzz into a Marshall JCM800, Bob Balch a Marshall Super Bass/DSL100H with Creepy Fingers fuzz. Suggested real row if promoted: "Hung Up in Heaven | Fu Manchu | Scott Hill / Bob Balch | California Crossing (2001) | Ampeg Dan Armstrong -> Marshall JCM800, Univox Super-Fuzz.") | reference |
...
| 184 | The Last in Line (solo) | Dio | Vivian Campbell | The Last in Line (1984) | GEAR SKETCH CORRECTED 2026-08-19 (was "Charvel super-strat (Floyd Rose)"): the Charvels are the LAST IN LINE TOUR guitars, not the studio ones. The 1984 studio guitar is the same 1977 Les Paul Deluxe as the rest of the Dio era — Belfast-bought, sanded/repainted matte black, jumbo frets, brass nut, DiMarzio X2N bridge. Rig is "a Les Paul through an overdrive pedal into a Marshall" (JCM800 2203) with a Boss SD-1 always-on as a level box; the solo-only addition is an Ibanez Tube Screamer ("a Tube Screamer on a couple of solos"). Caribou Ranch, spring 1984, RJD producing. TRAP: his ENGL Blackmore comments refer to re-recording with the band Last In Line decades later, not 1984. Original sketch: Charvel super-strat (Floyd Rose) → JCM800, Boss OD boost (Note 2026-08-05: DEFERRED one run for tonal variety — #182 ships the same artist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | done |
...
| 187 | The Mob Rules (riff) | Black Sabbath | Tony Iommi | Mob Rules (1981) | GEAR SKETCH CORRECTED 2026-08-19 (was "Gibson SG Special → Laney Klipp, treble boost"): by 1981 the Laney/treble-booster rig was long gone. Iommi ran the Dawk Stillwell-modified Marshall 1959 Super Lead (extra gain stage + master volume) he had used since 1979, and his documented main guitar through Mob Rules is the BLACK 24-fret John Birch SG Custom (c.1975, Birch Magnum pickups, stop tailpiece, Grovers) — not 'Monkey'. Jaydee 'Old Boy' for overdubs. .008-.032 strings. Recorded Record Plant LA, Martin Birch producing; the title track was ALSO cut separately at Tittenhurst Park for the Heavy Metal soundtrack — a different recording. Original sketch: Gibson SG Special → Laney Klipp, treble boost, light-gauge strings (Note 2026-08-05: DEFERRED one run for tonal variety — #185 ships the same artist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | done |
...
| 190 | Flying High Again (solo) | Ozzy Osbourne | Randy Rhoads | Diary of a Madman (1981) | GEAR SKETCH CORRECTED 2026-08-19: producer Max Norman says "Randy used a polka-dot Charvel on pretty much all the guitar tracks" — i.e. the 1979 KARL SANDOVAL polka-dot Flying V (mahogany body, Danelectro-derived maple neck w/ rosewood board + bow-tie inlays, DiMarzio PAF neck / DiMarzio Super Distortion bridge, harpoon headstock), NOT the Jackson Concorde or the Les Paul Custom. Album is tuned a HALF-STEP DOWN (Eb). Marshall 1959 Super Lead + MXR Distortion+ + MXR 10-band EQ (before the amp, as a 2nd boost stage). NO Variac claim for Diary — that is documented for the Blizzard sessions only. Ridge Farm, Rusper, early 1981, Max Norman producing+engineering. Original sketch: Jackson Concorde/Les Paul Custom → Marshall Super Lead, MXR Distortion+ and chorus (Note 2026-08-05: DEFERRED one run for tonal variety — #188 ships the same artist and the same rig from this cluster, so writing these in one batch would produce near-identical block notes. Gear sketch is unchanged and ready; promote on a later run.) | done |
...
| 194 | Fast as a Shark (riff) | Accept | Wolf Hoffmann | Restless and Wild (1982) | GEAR SKETCH CORRECTED 2026-08-19: the Strat is right (Hoffmann: "On Restless And Wild, Balls To The Wall, everything was recorded on a Strat" — HSS, humbucker bridge; he has NEVER recorded with a Flying V). The boost is NOT an MXR Distortion+ — it is an original Dallas Rangemaster germanium treble booster, which he documents as being in the studio chain on every 80s/90s Accept album. Amp: vintage Marshall Super Lead 100 (also a 1980 50W JMP MkII). Dierks Studios Cologne, Feb-Mar + June 1982, Michael Wagener engineering/mixing. Original sketch: Fender Stratocaster (studio) → Marshall stack, MXR Distortion+, bright single-coil attack | done |
| 195 | Restless and Wild (solo) | Accept | Wolf Hoffmann | Restless and Wild (1982) | SHIPPED 2026-08-26 as hoffmann-restless-and-wild-solo. Same documented rig as #194 (Strat with bridge humbucker, original Dallas Rangemaster, Marshall Super Lead 100W, Dierks/Stommeln, Wagener) but written as a LEAD patch -- the differentiator is that every setting inverts the riff patch: gate loose not tight, Sag 6 not 3, Mid 7 not 6, cab backed off not close, real delay and plate rather than a slap and a dry room. | done |
| 196 | Balls to the Wall (riff) | Accept | Wolf Hoffmann | Balls to the Wall (1983) | Fender Strat → Marshall stack, Dallas Rangemaster treble booster (CORRECTED 2026-08-19 -- NOT an MXR Distortion+; see #194), mid-heavy grind. Note 2026-08-26: still DEFERRED -- #194 and #195 have now both shipped from this Hoffmann/Rangemaster cluster, so a third same-rig recipe needs a genuinely different angle (Balls to the Wall is a slower, mid-heavy grind rather than a speed riff or a lead, which is a legitimate one). Gear sketch unchanged and ready. | queued |
| 197 | Am I Evil? (riff/solo) | Diamond Head | Brian Tatler | Lightning to the Nations (1980) | GEAR CONFIRMED + EXTENDED 2026-08-19 by Tatler first-person quote: "I used my Flying V on every song with a Marshall 2203 model 100 watt amp into a Laney 4x12 cab and a Morley power/wah/boost pedal for solos." Cab is a LANEY, not a Marshall. Key tone detail: "I played the whole of 'Am I Evil?' with the wah-wah on for a cutting nasal sound. It's double-tracked, so one side is with the wah on, the other side is without." V bought new 1979, stock. Worcester studio ("very dead"), engineer Paul Robbins, 7 days to record+mix. Original sketch: White Gibson Flying V → Marshall Master Volume JMP, Morley Power Wah Boost | done |
| 198 | The Lightning to the Nations (riff) | Diamond Head | Brian Tatler | Lightning to the Nations (1980) | SHIPPED 2026-08-26 as tatler-lightning-to-the-nations-riff. Tatler quote covers every song on the album: Flying V (1979, stock) → Marshall 2203 100W → LANEY 4x12, Morley Power Wah Boost. KEY DIFFERENTIATOR from #197: the Morley was "for solos" -- Am I Evil is the exception where he left it cocked for the whole take, so the title-track riff ships with the wah OFF and parked. Second correction carried forward: the 2203 is a MASTER-VOLUME amp with a preamp gain stage, not a non-master Plexi, which is why this record is tighter than its NWOBHM contemporaries. Old Smithy, Worcester; producer Reg Fellows. | done |
| 199 | Wheels of Steel (riff) | Saxon | Graham Oliver / Paul Quinn | Wheels of Steel (1980) | needs-research -- SKIPPED 2026-08-26. Studio and personnel are documented (Ramport, London, Feb 1980; Pete Hinton + Saxon producing, Will Reid-Dick engineering) but NO source ties a specific guitar or amp to these sessions. Paul Quinn's own 2016 Vintage Guitar interview covers the Wheels of Steel title track and names no gear at all -- and complicates the record further: he recalls the title track, "Suzie Hold On" and "747" being cut at a Welsh studio "run by hippies, up in the mountains," not at Ramport. The "Les Paul / SG → Marshall 100W stacks, Cry Baby" sketch is unsourced. Needs a session-specific gear source before this or #200 can ship. | needs-research |
| 200 | 747 (Strangers in the Night) (solo) | Saxon | Paul Quinn / Graham Oliver | Wheels of Steel (1980) | needs-research -- SKIPPED 2026-09-03, same blocker as #199 and confirmed by a second research pass. No source ties a guitar or amp to these February 1980 sessions. What surfaced this run is provenance for Graham Oliver's later touring gear (a white 1969 Gibson SG bought in 1974, a 1972 Marshall Super Lead 100 serial 6286D) but it comes from a dealer listing whose own provenance claim is about Randy Rhoads, not about Wheels of Steel -- so it cannot carry a session claim. Oliver's Get Ready to Rock interview names no gear beyond wanting an SG because of Iommi; Vintage Guitar 403s. Solo attribution between Quinn and Oliver is also undocumented, which matters more here than on #199 because this row is a SOLO recipe. Needs a session-specific gear source AND a solo attribution before it ships. | needs-research |
| 201 | I Will Survive (intro/solo) | Mercyful Fate | Hank Shermann / Michael Denner | Don't Break the Oath (1984) | needs-research -- SKIPPED 2026-08-26. No source ties any guitar or amp to the 1984 Don't Break the Oath sessions. What exists is either wrong-era or unverifiable: Shermann's documented early gear (Marshall 1959 Super Lead driven to Holland in a VW van, 1975 Strat with a DiMarzio FS-1, Tokai Silverstar, LPB-1) is EP/Melissa-era, and his Rig-Talk gear posts are about the 2024 album. Denner's "Marshall 100W/JCM800, TS-9, Crybaby" is career-general and only appears on Equipboard, which is now 403. The 30th-anniversary Blabbermouth interview says only that they "tuned and tweaked the guitars and amps as we did back in 1984" without naming one. NOTE: this blocker is album-wide, so #202 almost certainly shares it -- check before spending a slot on it. | needs-research |
| 202 | A Dangerous Meeting (riff) | Mercyful Fate | Hank Shermann / Michael Denner | Don't Break the Oath (1984) | SHIPPED 2026-09-03 as shermann-a-dangerous-meeting-riff. UNBLOCKS #201's album-wide blocker: a first-party source the 2026-08-26 pass missed is Shermann's own official Facebook photo caption, which names the rig directly -- "Mercyful Fate 1983! 100W Marshall 1959 & 2203 Amps. Self-painted Jap-Strat with a DiMarzio Super Distortion Pick-up! Loud Set-up." That is the 1983 rig and the album was cut in May 1984, so it is era-adjacent rather than session-specific, and the recipe says so. Denner side is corroborated separately (Marshall JMP Super Lead 100W from 1983 Dynamo footage, Gibson Flying V, Ibanez TS9, Dunlop Cry Baby). CORRECTION to the original sketch: the "Gibson Flying V/Les Paul" is Denner's half only -- Shermann is on a Strat-style guitar, and the Flying V for both is wrong. Shermann's documented pedal is a late-70s block-logo MXR Distortion+, not a Boss overdrive. Easy Sound Recording, Copenhagen, May 1984; rhythm section tracked live per Denner. #201 can now be re-queued on the same sourcing. | done |
| 203 | Tooth and Nail (riff) | Dokken | George Lynch | Tooth and Nail (1984) | SHIPPED 2026-08-26 as lynch-tooth-and-nail-riff. MAJOR CORRECTION: the amp is NOT a modded Marshall -- Lynch has said he used RANDALL RG100ES SOLID-STATE heads for the entire Tooth and Nail record and tour (corroborated by his sound tech for this album and by a later Lynch interview on the Randall solid-state reissue, where he calls those "the good ones"). The Metaltronix/Lee Jackson-modded plexis are real but belong to Back for the Attack. Guitar is a pre-ESP Charvel-type super-strat, maple body/neck, ebony board, Duncan Distortion bridge, Floyd Rose -- Kamikaze/ESP is anachronistic for 1984. Cherokee Studios Hollywood, Apr-Aug 1984, Tom Werman + Roy Thomas Baker. Accounts vary on the exact Randall designation (RG-80 also appears), noted honestly in the recipe. | done |
| 204 | Into the Fire (solo) | Dokken | George Lynch | Tooth and Nail (1984) | DEFERRED 2026-09-03 -- gear is fully researched and solid (identical to #203: Randall RG100ES solid-state for the whole record and tour, pre-ESP Charvel-type super-strat, Duncan Distortion, Floyd Rose, Cherokee Studios). BLOCKER is redundancy, not sourcing: we now have two Lynch recipes, and this row would be the third with the same album AND the same tone context as one of them -- lynch-tooth-and-nail-riff covers the Randall rig, george-lynch-mr-scary-lead covers the lead voice. The genuinely different angle available here is lead-on-a-solid-state-amp (sustain without power-supply sag), which is a legitimate one, but it wants a slot where it is not landing alongside another Lynch recipe. Built #205 in its place this run. Same convention as #196. | queued |
| 205 | Unchain the Night (riff) | Dokken | George Lynch | Under Lock and Key (1985) | SHIPPED 2026-09-03 as lynch-unchain-the-night-riff. SONG TITLE CORRECTED: this row said "Future Shock," which is not a Dokken song at all -- the Under Lock and Key tracklist is Unchain the Night / The Hunter / In My Dreams / Slippin' Away / Lightnin' Strikes Again / It's Not Love / Jaded Heart / Don't Lie to Me / Will the Sun Rise / Til the Livin' End (Future Shock is a 1981 Gillan album). Re-pointed to the album opener, which is the strongest riff candidate on the record. GEAR CORRECTION: the sketch's "Soldano-style high gain" is wrong -- producer Michael Wagener's account has two Lee Jackson-modified Marshalls and two Laneys split by frequency (Marshall high, Laney low), cabs across three rooms including one in a tiled bathroom and one in a dead room with a Boss chorus, 14 room mics plus 2 more into MCI 500 preamps bussed to one channel, a UREI 530 across that bus, and a Fostex 4-track run in total overdrive under a blanket as a saturation stage before the 3M 32-track. Rockman mixed in underneath. Guitar is the sunburst "Tiger" -- Lynch's own 1980 build, used on the 1985 tour and this recording; the ESP endorsement and the Kamikaze both start in 1986, so both are anachronistic here. Amigo Studios, North Hollywood; Neil Kernon + Michael Wagener. | done |
| 206 | Ace of Spades (riff) | Motörhead | "Fast" Eddie Clarke | Ace of Spades (1980) | SHIPPED 2026-08-26 as clarke-ace-of-spades-riff. MAJOR CORRECTION: NOT a Les Paul. Clarke had to sell his 1972 Les Paul Deluxe before joining Motorhead and only recovered it when he formed Fastway in 1982 -- every Motorhead album he plays on is a FENDER STRATOCASTER with DiMarzio pickups (X2N bridge, SDS-1 neck, stock middle; the X2N post-dates 1976 so the exact 1980 set is hedged in the recipe). His stated reason is mix survival, not tone: Lemmy ran "a Rickenbacker bass through a Marshall amp with all the treble at maximum and all the bass at minimum." Amp is Marshall Plexi/JMP family -- the JCM800 he later used did not exist in 1980. Jackson's Studios, Rickmansworth, 4 Aug-15 Sept 1980, producer Vic Maile. Boss OD-1 documented in his chain, hedged as era-consistent for the sessions. | done |
| 207 | Overkill (riff) | Motörhead | "Fast" Eddie Clarke | Overkill (1979) | SHIPPED 2026-09-03 as clarke-overkill-riff. GEAR CORRECTION carried from #206: the sketch's "Gibson Les Paul Deluxe" is wrong -- Clarke had pawned the Les Paul before Motorhead and did not recover it until Fastway in 1982, so this is the DiMarzio-loaded Stratocaster. Extra caveat specific to this row and stated in the recipe: the X2N bridge pickup was released in 1979 and these sessions ran December 1978 into January 1979, so the pickup set is hedged harder here than on #206. DIFFERENTIATOR from the Ace of Spades recipe, which shares the rig almost exactly: the producer. Jimmy Miller (Beggars Banquet, Let It Bleed, Sticky Fingers, Exile on Main St.) recorded this at Roundhouse and Sound Development over six weeks and left the room, the speaker breakup and the dynamics in -- so Overkill is furrier, wider and far less compressed than Vic Maile's Ace of Spades eighteen months later. The recipe is built around that difference: looser gate, gentler comp, more sag, distant ribbon in the cab blend, room instead of plate. | done |
| 208 | Speak of the Devil (solo) | Queensrÿche | Chris DeGarmo / Michael Wilton | Operation: Mindcrime (1988) | needs-research -- SKIPPED 2026-09-03. PHANTOM SONG: there is no Queensrÿche track called "Speak of the Devil." The Operation: Mindcrime tracklist is I Remember Now / Anarchy-X / Revolution Calling / Operation: Mindcrime / Speak / Spreading the Disease / The Mission / Suite Sister Mary / The Needle Lies / Electric Requiem / Breaking the Silence / I Don't Believe in Love / Waiting For 22 / My Empty Room / Eyes of a Stranger. The row was most likely meant to be "Speak" (track 5). Also correct the gear sketch before re-queuing: the Soldano preamp attributed to DeGarmo belongs to the Empire era (1990), when both players left the JCM800s for Bradshaw rigs -- on Mindcrime they shared identical Marshall JCM800 100W heads into V30 4x12s plus custom overdriven 1x12 "compression boxes." Re-queue as "Speak (riff)" if a distinct angle from #209 exists. | needs-research |
| 209 | Eyes of a Stranger (solo) | Queensrÿche | Chris DeGarmo / Michael Wilton | Operation: Mindcrime (1988) | SHIPPED 2026-09-03 as degarmo-eyes-of-a-stranger-solo. Solo attribution resolved: DeGarmo plays the main solo and the second half is harmonised with Wilton -- which is why the recipe is filed under DeGarmo rather than Wilton, reversing this row's ordering. GEAR CORRECTION: the sketch's "Roland JC-120 for clean lead" is not confirmed for this record and was dropped. Both guitarists ran identical rigs until Empire -- Marshall JCM800 100W heads into Marshall 4x12s with Celestion Vintage 30s -- plus the detail that carries the recipe: custom 1x12 "compression boxes" driven so far past their rating that three failed during the sessions, which is where the album's hard, vivid guitar edge comes from. Roland and Yamaha rack processors for chorus and delay, in the loop. DeGarmo was the warmer voice, Wilton the brighter. Kajem/Victory (Gladwyne PA) and Le Studio (Morin Heights QC), producer Peter Collins. | done |
| 210 | I Don't Believe in Love (solo) | Queensrÿche | Chris DeGarmo | Operation: Mindcrime (1988) | ESP → JCM800 + Soldano preamp, BBE Sonic Maximizer, TC chorus DEFERRED 2026-09-09 -- gear is researched and fine (ESP -> JCM800 + Soldano preamp, BBE Sonic Maximizer, TC chorus). BLOCKER is redundancy, not sourcing: degarmo-eyes-of-a-stranger-solo already ships the same guitarist, the same album (Operation: Mindcrime), the same tone_context (solo) and the same JCM800 rig -- and that recipe's own description says it holds whichever part you are playing. The rack details here are a differentiator on paper but not an audibly different tone. Re-queue when it can land on a genuinely different angle (the Soldano preamp as its own voice, or a Wilton-side recipe contrasting the twin-guitar split). Same convention as #196 and #204. | queued |
| 211 | A Tale That Wasn't Right (clean/solo) | Helloween | Kai Hansen / Michael Weikath | Keeper of the Seven Keys Part I (1987) | Hansen Rockinger RR-style / Weikath ESP → modded Marshall 1987, clean-to-gain dynamics | done |
| 212 | I'm Alive (riff) | Helloween | Kai Hansen / Michael Weikath | Keeper of the Seven Keys Part I (1987) | Rockinger/ESP V-style → modded Marshall 1987 (boosted master/gain), harmonized leads | done |
| 213 | Eagle Fly Free (solo) | Helloween | Michael Weikath / Kai Hansen | Keeper of the Seven Keys Part II (1988) | ESP guitars → ENGL amps (from Keeper II sessions), fast melodic twin leads NEEDS-RESEARCH 2026-09-09 -- the queued premise 'ESP guitars -> ENGL amps (from Keeper II sessions)' does not survive checking. Kai Hansen's documented amp across this period is a Marshall 1987 50W modified for master volume, used since before Keeper Part I; no source found puts ENGL on the 1988 Keeper II sessions, and Helloween's ENGL association is a later (1990s) chapter. Also unresolved: who plays which of the twin leads on this track. What is documented is the studio (Horus Sound Studio, Hannover, May-June 1988, Tommy Newton and Tommy Hansen). Needs a primary source naming the Keeper II amps before it can ship. | needs-research |
| 214 | Pull Me Under (riff) | Dream Theater | John Petrucci | Images and Words (1992) | SHIPPED 2026-09-03 as petrucci-pull-me-under-riff. Promoted ahead of #200/#204/#208 this run because three top-of-queue rows were blocked (two phantom/under-sourced, one redundant) and this one is both well sourced and a different decade from the rest of the batch. GEAR CORRECTION to the sketch's "Mesa/Boogie Mark series": the Mark IIC+ association everyone assumes for this album belongs to Awake (1994) and later -- Images and Words was cut on Mesa RACK gear, a Quad Preamp and a Triaxis into a 2:90, with a Marshall JMP-1 used specifically on Metropolis Pt. 1 and a Roland JC-120 for the clean sections. Honest limit stated in the recipe: Petrucci has given inconsistent accounts across interviews and no definitive published timeline exists, so the Quad Preamp is the best-supported claim rather than settled fact; the Mark-lineage family and the post-preamp graphic EQ are not in dispute and are what actually determine the dial-in. Guitar is the first Ibanez JPM prototype -- DiMarzio Tone Zone bridge, Humbucker From Hell neck, proprietary 3-way 4PDT switch giving an inner-coil middle position. BearTracks Studios (Suffern NY) + The Hit Factory, Oct-Dec 1991, producer David Prater. | done |
| 215 | Links: [{"title":"John Petrucci | Dream Theater Wiki | Fandom","url":"https://dreamtheater.fandom.com/wiki/John_Petrucci"},{"title":"John Petrucci - Wikipedia","url":"https://en.wikipedia.org/wiki/John_Petrucci"},{"title":"Rig Rundown: Dream Theater’s John Petrucci and John Myung [2019]","url":"https://www.premierguitar.com/gear/rig-rundown-dream-theaters-john-petrucci-and-john-myung-2019"},{"title":"Guitar's News World: John Petrucci Dream Theater","url":"http://guitarworldblog.blogspot.com/2007/12/john-petrucci-dream-theater.html"},{"title":"John Petrucci's Guitar Gear, Pedalboard & Amps | Equipboard","url":"https://equipboard.com/pros/john-petrucci"},{"title":"John Petrucci Guitars and Gear 2026: Complete Setup Guide","url":"https://powersof10.com/john-petrucci-guitars-and-gear/"},{"title":"John Petrucci Amp Settings & Guitar Rig - A Closer Look!","url":"https://musicstrive.com/john-petrucci-amp-settings/"},{"title":"Dream Theater - John Petrucci's Guitar Gear Rig and Equipment","url":"https://www.uberproaudio.com/who-plays-what/190-dream-theater-john-petruccis-guitar-gear-rig-and-equipment"},{"title":"Rig tour: Dream Theater's John Petrucci | (research links row for a future John Petrucci recipe, not a recipe -- malformed by a prior run. Reclassified 2026-08-26, same convention as #105/#106/#163. Links preserved in git history; the real Petrucci row is #214.) | reference |
| 216 | Roundabout (intro/solo) | Yes | Steve Howe | Fragile (1971) | Gibson ES-5 Switchmaster → Fender Dual Showman, bright hollowbody bite, harmonics intro CORRECTION on shipping 2026-09-09: the queued sketch credited the 'harmonics intro' to the electric. It is not -- the intro harmonic and the classical-style figure are a Martin 00-18 acoustic, Howe's first use of that guitar on a Yes record, and no amp patch reproduces it. The ES-5 Switchmaster / Dual Showman half of the sketch is correct and is what the shipped recipe covers; the recipe states the acoustic caveat up front. | done |
| 217 | Yours Is No Disgrace (riff) | Yes | Steve Howe | The Yes Album (1971) | Gibson ES-175 → Fender Dual Showman, biting jangle, no pedals DEFERRED 2026-09-09 -- gear researched and solid (Gibson ES-175D -> Fender Dual Showman into 2x15 cabs, no pedals). BLOCKER is redundancy within the Howe cluster: this run shipped howe-roundabout-lead (ES-5 Switchmaster, Fragile) and howe-siberian-khatru-riff (ES-175 split across two amps in stereo, Close to the Edge), and this row is a third Howe recipe on the same ES-175-into-Dual-Showman rig with no technique that the Khatru recipe does not already cover better. The genuinely different angle available is the 1971 Yes Album production -- a drier, earlier, more mono capture than either shipped recipe -- which is legitimate but wants a slot where it is not landing beside two other Howe entries. Same convention as #196 and #204. | queued |
| 218 | Siberian Khatru (head) | Yes | Steve Howe | Close to the Edge (1972) | Gibson ES-345 stereo → two Dual Showmans, dual-amp stereo delay CORRECTION on shipping 2026-09-09: the queued sketch said 'Gibson ES-345 stereo -> two Dual Showmans'. Howe names the ES-175 for this track specifically, and the pair was ONE Dual Showman plus a second four-speaker Fender combo -- not two Showmans. He describes the split as back pickup to the Showman, front pickup to the other amp, recorded in stereo. He calls the second amp a 'Super Twin', but that model postdates the record by four years and is a 2x12, so the shipped recipe specifies the speaker count and tonal role rather than asserting a model number. ES-345 belongs to other Close to the Edge tracks, not this one. | done |
| 219 | Firth of Fifth (solo) | Genesis | Steve Hackett | Selling England by the Pound (1973) | SHIPPED 2026-08-26 as hackett-firth-of-fifth-solo. Guitar confirmed by Hackett first-person (MusicRadar): "I think I got my Les Paul in about 1972. It's the one I used on Selling England By The Pound - on Firth Of Fifth and Dancing With The Moonlit Knight." 1957 Goldtop, NECK pickup (the detail most covers get wrong). Effects are the Peter Cornish-built board: Schaller volume pedal, Marshall Supa Fuzz + Shaftesbury Duo-Fuzz (Tone Bender-lineage germanium), Colorsound Octivider. HONEST AMBIGUITY carried into the recipe: Hackett says of the Genesis years "I used to use Hiwatt amps and then a little Fender Champ or a Pignose and various small amps to record with," and an HH solid-state head is reported for this album -- recipe is built on the Hiwatt DR103 since the character (huge clean headroom under a germanium fuzz) holds either way. Island Studios London, Aug 1973, John Burns + Genesis. Also documented: the famous sustained note was technique, not a sustainer. | done |
| 220 | Dancing with the Moonlit Knight (tapping) | Genesis | Steve Hackett | Selling England by the Pound (1973) | Les Paul Goldtop → Hiwatt, Shaftesbury Duo-Tone fuzz, early tapping | done |
...
| 2026-08-19 | campbell-the-last-in-line-solo | 184 |
| 2026-08-19 | iommi-the-mob-rules-riff | 187 |
| 2026-08-19 | rhoads-flying-high-again-solo | 190 |
| 2026-08-19 | hoffmann-fast-as-a-shark-riff | 194 |
| 2026-08-19 | tatler-am-i-evil-riff | 197 |
| 2026-08-26 | hoffmann-restless-and-wild-solo | 195 |
| 2026-08-26 | tatler-lightning-to-the-nations-riff | 198 |
| 2026-08-26 | lynch-tooth-and-nail-riff | 203 |
| 2026-08-26 | clarke-ace-of-spades-riff | 206 |
| 2026-08-26 | hackett-firth-of-fifth-solo | 219 |
| 2026-09-03 | shermann-a-dangerous-meeting-riff | 202 |
| 2026-09-03 | lynch-unchain-the-night-riff | 205 |
| 2026-09-03 | clarke-overkill-riff | 207 |
| 2026-09-03 | degarmo-eyes-of-a-stranger-solo | 209 |
| 2026-09-03 | petrucci-pull-me-under-riff | 214 |
| 2026-09-09 | hansen-a-tale-that-wasnt-right-lead | 211 |
| 2026-09-09 | hansen-im-alive-riff | 212 |
| 2026-09-09 | howe-roundabout-lead | 216 |
| 2026-09-09 | howe-siberian-khatru-riff | 218 |
| 2026-09-09 | hackett-moonlit-knight-tapping | 220 |
