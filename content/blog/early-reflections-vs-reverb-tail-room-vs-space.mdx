...
takeaways:
  ...
  - >-
    More reverb does not equal bigger. A long tail pushes a guitar back and makes
    it smaller and more distant. A burst of dense early reflections with almost
    no tail makes it sound closer and more solid.
  - >-
  ...
  - >-
    Early-reflection density reads as size. Sparse, late reflections sound like a
    cathedral; fast, dense reflections sound like a small bright room. Adjust the
    spacing, not just the level.
faq:
  - q: What is the difference between early reflections and the reverb tail?
    a: >-
      ...
      the direct sound, the sound bouncing once off the nearest walls, floor, and
      ceiling, arriving within roughly the first 80 milliseconds. The tail is
      everything after that, where the reflections become too dense and frequent
      to hear individually and blur into a smooth decay. Early reflections define
      the room's size and your distance; the tail defines how long the space
      rings out.
  - q: Why does adding more reverb make my guitar sound further away?
    a: >-
      ...
      decay short. That fills out the sound without pushing it to the back of the
      room.
  ...
  - q: How do I make a reverb sound like a small room instead of a big hall?
    a: >-
      ...
      for seconds. So a short decay with dense, early, closely spaced reflections
      and a small predelay reads as a tight room; long decay with sparse, late
      reflections reads as a hall.
  - q: Should I high-cut the reverb return?
    a: >-
      Usually, yes. Rolling off the top of the reverb above roughly 6 to 8 kHz
      keeps the reflections from adding glare and helps the reverb sit behind the
      dry guitar instead of competing with its attack. Real rooms absorb high
      frequencies as sound travels, so a darker reverb return also sounds more
      natural, like the space is actually swallowing some of the brightness.
---
