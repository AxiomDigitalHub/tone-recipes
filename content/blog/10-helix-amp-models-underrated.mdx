...
**The key insight:** Pair it with the G12 Celestion Blue (or Greenback) IR or cab, not a big Celestion 65. The small amp/small speaker combination is where it lives.
...
**Best for:** Delta blues and slide, low-gain roots rock, anything that needs harmonic complexity without modern gain staging.
...
**Best for:** Progressive metal, modern rock, extended range guitars, anything requiring gain with retained note definition.
...
**Best for:** Blues-rock, classic rock, any lead tone where you want organic gain that responds to pick dynamics.
...
Two things: first, make sure the Master volume is high enough (around 2 o'clock) to engage the power amp simulation. Second, try a different cab — the Soup Pro responds well to a 1x12 Celestion Blue or Greenback rather than a larger modern speaker simulation. The combination of the smaller amp model with a smaller speaker model is where the character lives.
