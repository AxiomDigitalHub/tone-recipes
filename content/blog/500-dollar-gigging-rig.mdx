...
readingTime: "10 min"
updated: "2026-06-30"
image: "/images/blog/500-dollar-gigging-rig.jpg"
image_alt: "An affordable gig-ready guitar rig — guitar, amp, and a few pedals — laid out to show a capable $500 setup"
takeaways:
  - >-
    A complete, gig-ready rig — guitar, amp or modeler, cables — comes together
    for around $500 on the used market in 2026, with no compromise an audience
    would ever hear.
  - >-
    Spend the biggest share on the guitar. A Squier Classic Vibe at $200–250 used
    outplays its price and is the one part of the rig you actually feel.
  - >-
    Rig A (Boss Katana 50 plus one fuzz) is the real-amp route — heavier to
    carry, dead simple to run, and able to fill a PA-less room on its own.
  - >-
    Rig B (Line 6 HX Stomp direct to the PA) is the portable route — one-trip
    load-in, a consistent house sound every night, and the same amp models as the
    $1,700 Helix Floor.
  - >-
    At this budget you skip backup gear but never backup consumables. One spare
    instrument cable is the cheapest insurance policy a gigging guitarist owns.
faq:
  - q: Can you really build a gigging rig for $500?
    a: >-
      Yes, on the used market. A Squier Classic Vibe at $200–250 plus either a
      used Boss Katana 50 (~$150) and a fuzz, or a used Line 6 HX Stomp (~$300)
      run direct, lands a complete, stage-ready rig in the $440–575 range
      depending on the route and how patient your shopping is. The prices are
      what these actually sell for, not a fantasy list.
  - q: Should I get the Boss Katana or the HX Stomp on a budget?
    a: >-
      Get the Katana if you want a real amp pushing air behind you, you play
      rooms without a PA, or you want to add pedals one at a time. Get the HX
      Stomp if you value a one-trip load-in, you play venues with a PA, and you
      want the deepest tone-shaping for the money. The Katana is cheaper and
      simpler; the Stomp is lighter and grows into a full pedalboard replacement.
  - q: What's the best cheap guitar for gigging?
    a: >-
      A used Squier Classic Vibe Telecaster or Stratocaster at $200–250. The fit
      and finish punch well above the price — rolled fretboard edges, alnico
      pickups, stable tuning. Budget alternatives include the Epiphone Les Paul
      Standard '50s for humbuckers or a G&L Tribute. Whatever you buy, spend
      $40–60 on a proper setup; it's the highest-value upgrade in all of guitar.
  - q: Do I need backup gear for a budget gig rig?
    a: >-
      Not redundant amps or pedals — those are the next budget tier. What you do
      need is backup consumables: a spare instrument cable, a 9V, a clip-on
      tuner coin cell, one string, strap locks. That whole kit costs less than a
      patch cable and covers the failures that actually end sets.
  - q: Is a used HX Stomp worth it over buying an amp?
    a: >-
      For a gigging player with PA access, often yes. The HX Stomp runs the same
      amp models as the full Helix, goes direct to the board for a consistent
      house sound, and replaces your amp, drives, delay, reverb, and modulation
      in one lunchbox-sized unit. The trade is fewer simultaneous blocks and a
      higher up-front cost that squeezes the rest of the budget.
---

## Five Hundred Dollars, a Full Rig, and No Excuses

Five hundred dollars. Guitar, amp or modeler, cables, the works. A complete gigging rig that holds its own on a real stage in front of real people. The used market in 2026 is absurdly good for this. Gear depreciation is your best friend.
...
Spend the biggest chunk here. A bad-feeling guitar will make you not want to play, which makes everything else pointless.
...
### The Amp: [Boss Katana](/platforms/katana) 50 MkII (~$150 Used)
...
You have about $50-60 left after the guitar and amp. One pedal. Make it count. The [Big Muff](/gear/electro-harmonix-big-muff-pi) gets you a wall of fuzz that the Katana's built-in drive models can't replicate -- that thick, sustaining, everything-is-distorted-including-the-air sound. The nano version fits in your pocket. The Op-Amp reissue (the Smashing Pumpkins one) is slightly more aggressive and cuts through a band mix better.
...
The weak link in any budget rig is cables. Carry one spare instrument cable. That's it. That's the insurance policy. The cable is the failure that ends the most sets, but it isn't the only cheap part that quits at the worst possible moment — a [gig-bag reliability kit](/blog/gig-bag-reliability-kit-failure-modes) maps one item to every common way a set dies (dead 9V, broken string, dead tuner battery, loose strap button), and the whole thing costs less than a single boutique patch cable. Backup *gear* is for the next budget tier. Backup *consumables* are non-negotiable at any budget.
