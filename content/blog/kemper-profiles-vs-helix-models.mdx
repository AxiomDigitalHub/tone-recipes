...
<SaveThisTone
  title="Browse Kemper presets"
  description="Every recipe in our library translated for Kemper — signal chain, exact settings, ready to load."
  href="/browse?platform=kemper"
  ctaLabel="Browse Kemper presets"
/>
