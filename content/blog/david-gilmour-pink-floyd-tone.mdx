...
seo_title: "David Gilmour Tone Recipe: Pink Floyd Settings"
description: "David Gilmour's Pink Floyd tone decoded: amp settings, Big Muff dials, delay chains, and song settings for Comfortably Numb, Time, and Shine On."
date: "2026-03-29"
...
readingTime: 13
image: "/images/blog/david-gilmour-pink-floyd-tone.jpg"
image_alt: "A Pink Floyd-style rig — Strat, fuzz, and delay — set up for David Gilmour's tone on Comfortably Numb and Time"
---

> **Start Here:** Gilmour's tone is built on four interlocking elements: a [Stratocaster](/gear/fender-stratocaster) with exceptional pickup character, a [Hiwatt DR103](/gear/hiwatt-dr103) pushed hard enough to breathe but not to break, a [Big Muff Pi](/gear/electro-harmonix-big-muff-pi) set *lower* than you expect, and delay with enough trails to give every note a room to live in. The single most common mistake people make with this tone is running the Big Muff's Sustain at maximum. Don't. The amp is doing more of the work than the pedal, and the pedal needs the amp's headroom to deliver note definition rather than pure compression. Start with Sustain around noon, set your delay first, and build everything else around the space you're trying to fill.
...
The solo from "[Comfortably Numb](/recipe/gilmour-comfortably-numb-solo)" (both the studio version on *The Wall* (1979) and the live version from *The Wall Live at Earl's Court* (1980/81)) is the benchmark Gilmour lead tone and the one most players come here to find. Here are the settings.
...
| Amp | Hiwatt DR103 model ("WhoWatt 100" on Helix) | Volume high, Master around noon; push the preamp |
