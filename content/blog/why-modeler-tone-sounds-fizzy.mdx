...
On the Helix, use a **Parametric EQ** block and set the high cut. On the Quad Cortex, use the global EQ or an EQ block at the end of your chain. (Not sure which modeler is right for you? Our [Helix vs Quad Cortex comparison](/blog/helix-vs-quad-cortex) covers the key differences.)
