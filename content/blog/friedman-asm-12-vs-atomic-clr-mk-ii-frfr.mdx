...
seo_title: "Friedman ASM-12 vs. Atomic CLR Mk II: FRFR Compared"
description: >-
...
image_alt: >-
  a composition illustrating "Friedman ASM-12 vs. Atomic CLR Mk II: Powered FRFR
  With Character vs. Flat"
---
...
The ASM-12 isn't flat. It's voiced like a guitar cab: high end rolls off above 5 kHz, low-mid emphasis around 200 Hz, the slight cone-cry character a 12-inch speaker has at high SPL. If you run a cab-IR'd preset through the ASM-12, you get the cab IR's voicing on top of the ASM-12's voicing, producing two cab curves stacked. The result is usually an over-mid'd, honky tone with too much 1 kHz and not enough top end. Some players like this; most don't, especially if they spent time picking the IR.
...
The CLR Mk II takes the opposite approach. The 12-inch coaxial driver has a 1.5-inch compression driver, but the crossover is set so the system is as linear as possible across the audible range, with no deliberate high-end roll-off, no low-mid emphasis. The stated frequency response is 50 Hz to 20 kHz, which is full-range studio-monitor territory. The cabinet is bass-reflex (ported), which gives more low-end extension than the ASM-12's sealed design at the cost of some low-end transient definition.
...
If I ran the CLR preset (cab IR engaged) through the ASM-12 without changing anything, the result would have too much 1 kHz mids and a slightly hooded high end, with the IR's mid push and the ASM-12's mid push compounding. The fix would be either to kill the cab IR (which makes the preset wrong for the CLR) or to do a heavy parametric cut around 800 Hz to 1.2 kHz to compensate. Easier just to maintain two presets.

For more on getting modeler tones to translate well across different speaker situations, our [why your modeler sounds different at the gig guide](/blog/modeler-preset-sounds-different-gig) covers the related problem of in-ears vs. amps vs. FRFR, the same kind of speaker-coupling translation gap.
