...
seo_title: "Wet/Dry/Wet With One Modeler and One Real Amp"
description: >-
  You don't need three amps for a wet/dry/wet rig. A real amp for the dry
  center, a modeler for the stereo wet sides — the routing, the level matching,
  and the one ground-loop trap to dodge.
date: '2026-06-06'
...
takeaways:
  - >-
    ...
    feeding two powered speakers for the stereo wet sides — far cheaper than
    three matched amps.
  - >-
  ...
  - >-
    Latency is a non-issue here because the modeler only handles delay and
    reverb — a few milliseconds of delay before a 400 ms echo is inaudible, and
    the dry amp carries all the attack and feel.
  - >-
  ...
  - >-
    ...
    speakers sharing power; lift the ground on the wet side, not the amp, to
    kill the hum.
faq:
  ...
  - q: Why does my wet/dry/wet rig hum?
    a: >-
      ...
      ground on the wet side (the modeler's output or the powered speakers, via
      a ground-lift adapter or a transformer-isolated output) and leave the amp
