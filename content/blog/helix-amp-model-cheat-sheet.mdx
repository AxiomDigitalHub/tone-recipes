...
seo_title: "Helix Amp Model Cheat Sheet: Block to Real Amp"
description: >-
...
image_alt: >-
  A Line 6 Helix amp block on screen next to the real combo amp it models, with
  a decode chart mapping pseudonym to original
takeaways:
  - >-
    Line 6 gives every Helix amp model a fictionalized name to avoid trademark
    issues — US Double Vib is a Fender Twin Reverb, Cali Rectifire is a Mesa
    Dual Rectifier, Essex AC30 is a Vox AC30 Top Boost.
  - >-
    The Starting Gain column is a calibrated position where each model most
    accurately represents the real amp's character, not a ceiling — it's where
    to begin, then adjust to taste.
  - >-
    Master and Sag do more than Gain to make a model sound like the real amp,
    especially on clean and edge-of-breakup models; start Master at 50% and
    raise Sag on Fender-style amps for the bloom.
  - >-
    Hum and Ripple simulate an aging power supply and poorly filtered rectifier
    — useful for studio authenticity, but leave both at 0 for live use and
    general dialing.
  - >-
    Essex AC30 is the platform behind most modern worship tones; the same block
    covers both jangle and, with a Greenback cab, the warmer Bethel-style wash.
faq:
  - q: What real amp is the Helix Brit 2204 based on?
    a: >-
      The Brit 2204 is based on the Marshall JCM800 2203, the single-channel
      high-gain version from the early 1980s. The '2204' designation in the
      Helix name refers to the 50-watt head version of the same circuit.
  - q: What real amp is the Helix Cali Rectifire based on?
    a: >-
      The Cali Rectifire is based on the Mesa/Boogie Dual Rectifier in Modern
      mode. 'Cali' refers to California (Mesa/Boogie's base), and 'Rectifire' is
      Line 6's legal workaround for 'Rectifier.'
  - q: What is the Helix Placater amp model?
    a: >-
      The Placater Clean and Placater Dirty are based on the Friedman BE-100.
      'Placater' is the Helix pseudonym for 'Friedman,' which is itself named
      after Dave Friedman. The Dirty channel is the primary high-gain voice most
      players use.
  - q: What Helix amp is best for clean tones?
    a: >-
      US Double Nrm (Fender Twin Reverb) has the most headroom. US Deluxe Nrm
      (Fender Deluxe Reverb) is warmer and more touch-sensitive. Essex AC30 (Vox
      AC30) is chimier and responds differently to single-coils vs. humbuckers.
  - q: Does the Helix Sag control matter?
    a: >-
      Yes, significantly for clean and edge-of-breakup models. Sag controls how
      responsive the virtual power supply is. Higher Sag adds the bloom and
      compression of tube rectifier designs (like vintage Fenders). For
      high-gain models, the effect is usually less audible.
---
...
| Essex AC30 | Vox AC30 Top Boost | 45% | The jangle amp; Rickenbacker territory, The Edge's original platform, and the backbone of modern worship |
...
The Essex AC30 is worth a second look if you play worship: it's the amp block under most modern worship electric tones. Run it bright into a Blue cab and it's the chimey [Way Maker tone](/blog/way-maker-guitar-tone-helix); swap to a Greenback cab and voice it warmer and it's the [Goodness of God wash](/blog/goodness-of-god-guitar-tone-helix). Same block, two characters — the cab is doing more of the work than the amp. If you're building a Sunday setup around it, the [four-snapshot worship template](/blog/helix-worship-snapshots-sunday-morning) ties it together.
