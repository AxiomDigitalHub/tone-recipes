...
The Essex AC30 is worth a second look if you play worship: it's the amp block under most modern worship electric tones. Run it bright into a Blue cab and it's the chimey [Way Maker tone](/blog/way-maker-guitar-tone-helix); swap to a Greenback cab and voice it warmer and it's the [Goodness of God wash](/blog/goodness-of-god-guitar-tone-helix). Same block, two characters — the cab is doing more of the work than the amp. If you're building a Sunday setup around it, the [five-snapshot worship template](/blog/helix-worship-snapshots-sunday-morning) ties it together.
