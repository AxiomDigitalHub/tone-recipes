...
faq:
  ...
  - q: Does a wider nut slot cause buzzing?
    a: >-
      It can. If the slot is wider than the string, the string can rattle against
      the slot walls at the open position, and if the slot floor is also too flat
      or sloped the wrong way the front edge buzzes like a sitar. A buzz that is
      present open and gone the moment you fret is almost always a nut-slot
      problem, not a fret or truss-rod problem.
  - q: How do I fix a nut slot that is already too wide?
    a: >-
      ...
      If several slots are oversize, replacing the nut is usually faster and more
      reliable than filling each one.
---
