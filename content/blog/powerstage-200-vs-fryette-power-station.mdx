...
seo_title: "PowerStage 200 vs. Fryette: Class D or Tube"
description: >-
...
The use case: you have a modeler (Helix, Quad Cortex, Kemper, Tonex, whatever) running an amp model and an IR (impulse response) that simulates a cabinet. You want to bypass the IR and instead drive a real guitar cab (a 2x12 or 4x12 with real Celestions or Eminences) for the physical interaction of speaker breakup, room interaction, and the way a real cab behaves under playing dynamics.
...
For my use case (a Quad Cortex running Fortin NTS, M Britt IRs disabled, into a Mesa 2x12), the PowerStage 200 is exactly what I want. I've already shaped the tone at the modeler level. I want the power amp to be invisible.
