...
description: >-
  Spring, plate, hall, room, and shimmer reverb explained: when to use each
  type and the settings that make them sing on your board or modeler.
date: '2026-03-29'
...
featured: false
readingTime: 12 min
image: /images/blog/reverb-types-guide.jpg
image_alt: >-
  A spring reverb tank, a studio plate, and a cathedral-like hall shown side by
  side to illustrate the different spaces each reverb type places a guitar in
updated: '2026-06-14'
takeaways:
  - >-
    The five core reverb types are spaces: spring is a metal tank with a splashy
    attack, plate is a dense studio sheen, hall is a large slow tail, room is
    short invisible ambience, and shimmer is a synthetic pitched wash.
  - >-
    Match the type to context, not preference — hall or plate mixed higher when
    you play alone, room or short plate mixed low with a band, and room reverb as
    the always-on baseline for recording direct.
  - >-
    Spring reverb naturally rolls off low frequencies, which is why it sits so
    cleanly with overdriven amp tones, while hall and shimmer pile up in the
    low-mids and clutter a busy band mix.
  - >-
    Gated and ducking reverb are not reverb types — they're ways to shape any
    tail: gated cuts it off at a fixed point for a hard edge, ducking pulls it
    down while you play and lets it bloom in the gaps.
  - >-
    The most valuable reverb setting is the one you can't consciously hear — a
    short room around 9 o'clock that adds dimension and depth without announcing
    itself as an effect.
faq:
  - q: What are the main types of reverb?
    a: >-
      The five you'll meet most are spring, plate, hall, room, and
      shimmer/modulated. Spring is the splashy metallic tank inside a Fender amp;
      plate is a dense, smooth studio reverb; hall is a large, slow space; room
      is short, natural ambience; and shimmer is a digital invention that mixes
      pitch-shifted octaves into the tail. Each places the guitar in a different
      kind of space — or, in shimmer's case, a space that doesn't physically
      exist.
  - q: What's the difference between plate and hall reverb?
    a: >-
      A plate is denser and more immediate — the reflections arrive thick and
      fast, with a smooth bright sheen and no obvious sense of a physical room.
      A hall is bigger and slower, with a noticeable pre-delay and a long tail
      that reads as a large space. Plate flatters vocals and lead lines; hall
      creates distance and grandeur. In a band, plate stays out of the way better
      because its tail is shorter and tighter.
  - q: Which reverb is best for playing in a band?
    a: >-
      Room or a short plate, mixed low. Long hall and shimmer tails compete with
      the bass and drums for space in the low-mids and turn the mix to mud. Keep
      the decay short and the mix modest so the reverb adds dimension without
      filling the frequency range the rhythm section needs.
  - q: Why does spring reverb pair so well with overdrive?
    a: >-
      Spring tanks naturally roll off bass frequencies, so the reverb adds its
      splashy shimmer on top of the signal without thickening the low end. That
      keeps an overdriven tone clear instead of muddy, which is exactly why
      spring reverb built into a cranked amp sounds right where a big hall would
      smear the distortion.
  - q: What reverb should I use for ambient or post-rock?
    a: >-
      Hall or shimmer, mixed higher than you would in a band, usually with delay
      placed before the reverb so the echoes feed into the wash. That cascade is
      the foundation of ambient and post-rock guitar. Volume swells into a long
      shimmer reverb produce the evolving, synth-like pads the genre is built on.
  - q: Is gated or ducking reverb a type of reverb?
    a: >-
      No — they're tail-shaping techniques you apply to any reverb type. Gated
      reverb cuts the tail off abruptly at a fixed point for a hard, percussive
      edge; ducking reverb keeps the full tail but lowers its volume while you
      play and lets it return in the gaps. You can gate or duck a plate, a hall,
      or a shimmer — it's about what the tail does, not what space it simulates.
---
...
Spring reverb has a sound so specific that even people who don't know they're hearing it recognize it instantly. It's the drip. That splashy, metallic bounce that lives inside a Fender Deluxe Reverb or a Twin. It's the sound of a literal spring vibrating in a metal tank, converting electrical signal into mechanical energy and back again.
...
- **Ambient and atmospheric guitar:** hall reverb is the foundation of ambient guitar, the space that post-rock and shoegaze and [worship guitar](/blog/worship-guitar-tone-helix) inhabit
...
- **[Worship pedalboard](/blog/worship-pedalboard-guide):** shimmer reverb is a primary tool in modern worship guitar tone, providing the atmospheric wash that supports congregational singing
...
## Shaping the Tail: Gated and Ducking Reverb

Spring, plate, hall, room, and shimmer are all answers to one question — what kind of space is the guitar standing in. There's a second question none of them touch: what the tail *does* once it's there. Two techniques answer it, and both work on any of the types above.

A **gated reverb** takes a big, dense tail and cuts it off at a fixed point, so the space arrives full and then stops dead instead of decaying — the percussive, hard-edged sound that defined the drums on every 1980s record. A **ducking reverb** keeps the whole tail but lowers its volume while you play and lets it bloom back up in the gaps, so a long wash stays out of the way of your notes. Neither one is a *type* of reverb. They're ways to control the tail of whichever type you've already chosen — the difference between a part that's big and a part that's big *and* legible. I've pulled the two apart in full in [gated vs. ducking reverb](/blog/gated-reverb-vs-ducking-reverb); if a hall or a shimmer keeps swallowing your playing, the fix is usually one of those two rather than a different reverb.
