...
faq:
  - q: Why do I get hum when I run to both an amp and the front-of-house board?
    a: >-
      ...
      two grounds sit at slightly different potentials, current flows through the
      audio cable shield and you hear it as a steady 60-cycle hum. Lifting the
      ground on the front-of-house leg breaks the loop while keeping the amp
      grounded for safety.
  - q: Should I use an active buffered splitter or a transformer-isolated one?
    a: >-
      ...
      same circuit or you have never had hum. It is cheaper and adds no insertion
      loss. Move to a transformer-isolated splitter the moment you get hum that a
      ground lift on the DI does not fully solve, which is common in older
      buildings where the stage and the booth are on different breakers.
  - q: Where does the tuner go in a three-output rig?
    a: >-
      ...
      like the Boss TU-3, also have a buffered output you can use as the splitter
      itself in a simple rig.
