...
I have been running a Marshall Super Lead with pedals since before most of you were born. And the first time somebody showed me the 4-cable method, I thought it was overkill. Four cables to do what a pedalboard and a good amp already do. Then I heard my delays sitting behind the preamp instead of in front of it, and I shut my mouth.

The 4-cable method — also called 4CM or 4-wire — connects a multi-effects unit or modeler to a real guitar amp so you can place some effects *before* the amp's preamp and others *after* it. Your amp's actual preamp tone stays intact. The modeler handles the rest.

If you have ever wished your Helix delays and reverbs could sit in your amp's effects loop while a Tube Screamer model runs into the front input — this is how you do it.
...
Because you love your amp's tone but want modeler-quality effects. Simple as that.

Here is the longer version. Most guitarists who own both a modeler and a tube amp hit the same wall eventually. Going fully direct through the modeler — amp models into a PA or FRFR — gives you flexibility and consistency, but some of us know it does not match the push and response of a real amp moving real speakers in a real room. Meanwhile, running the modeler straight into the front of the amp is limiting. Time-based effects like delay and reverb belong *after* the preamp distortion. Not before it.
...
This matters most when you have a great tube amp with a distinctive voice. A cranked Marshall JCM800. A Fender Deluxe Reverb on the edge of breakup. A Mesa Rectifier with that tight low end. I have played my Super Lead since the late '70s. That amp has a feel no model has matched yet. The 4-cable method lets me keep that character and surround it with whatever effects I want.

## The 4 Cables Explained in Detail

Let me trace the signal path step by step. Understanding what each cable does is how you troubleshoot when something goes sideways at soundcheck.
...
The power amp amplifies everything and pushes it through the speaker. You hear your amp's preamp character, shaped by the modeler's effects, through your amp's power section and cabinet. End of story.
...
**Do not include an amp or cab block in the preset.** You are using your real amp and real cab. Adding a modeled amp on top of your real one will sound terrible — muddy, compressed, and wrong. I have seen guys do this at gigs and wonder why their rig sounds like a wet blanket. If you switch between 4CM presets and direct presets, make sure the 4CM presets have the amp/cab blocks removed or bypassed.
...
Getting these levels wrong is the number one cause of tone suck, volume drops, and noise in a 4CM setup. If something sounds thin, quiet, or noisy — check these settings first. Your ears don't lie.
...
Let me go deeper on signal levels. This is the technical detail that separates a great 4CM setup from one that makes you want to throw the whole rig off the stage.
...
I have dealt with this more times than I can count.
...
- **Check your cables.** Cheap cables with poor shielding make ground loop problems worse. There's no shortcut to tone — and that includes the cables you use.
...
The 4-cable method is not always the right answer. Here is how I think about it.
...
- You are happy with your modeler's amp tones (the modern ones are good — I will admit that)
- Simplicity matters — 4CM adds complexity, cables, and potential failure points

I will be honest. Fully direct has become good enough that many professional touring guitarists have abandoned real amps entirely. I respect the modelers. The 4-cable method is for players who genuinely prefer their real amp's character. But if you are setting up 4CM because you think modeler amp models are not good enough — try spending serious time dialing in the models first. Give them a fair shake. Then decide.
...
If you are willing to deal with four cables and a bit of initial troubleshooting, 4CM is worth the effort. Make sure your amp has an effects loop. Invest in quality cables. Take the time to match your signal levels. The payoff is a rig that sounds like *your* amp, with effects that sound like a professional studio.
