...
title: >-
  ...
  It's Worth It
seo_title: "Balanced Power: Furman P-2400 IT vs. Equi=Tech"
date: '2026-05-03'
description: >-
...
The first time I really understood what dirty power sounds like, I was running sound for a midweek service at a 1,200-seat church. The building had old wiring, the HVAC shared a circuit with our stage power, and every time the compressor kicked on, I could hear a low buzz creep into my in-ear mix. I spent three hours after service chasing that noise. It turned out to be a ground loop between the modeler and the tube amp, not a power problem at all. That night taught me the most important lesson in this whole article: diagnose first, spend second.

I've helped a half-dozen touring guitarists set up rack rigs over the years, and balanced power is the thing that gets recommended more often than it should be. Most of the time, when a guitarist tells me their rig is noisy, the problem is a ground loop between two pieces of gear or a dirty cable run going past a fluorescent ballast. Both of those are $20 fixes. Balanced power is a $2,500 fix for a different problem, and it's worth knowing which problem you actually have.
...
3. **Hybrid in-ear monitor systems on the same circuit as the guitar rig.** IEMs are sensitive to RF and to ground-borne noise; balanced power keeps the IEM monitor mix quieter and more stable, especially in venues with a lot of RF traffic from wireless mics, wireless guitars, and stage Wi-Fi. This is the one that hits close to home for me. In a worship setting, the whole band is on IEMs, and the congregation expects silence between songs. Any noise in the monitor mix is immediately obvious, both to the team and to the room.
...
The trade-off, and you'll see it in the specs, is that the Furman's common-mode rejection is about 40 dB at 60 Hz. That's meaningfully good, but not the best. Equi=Tech's passive transformer topology produces about 50 dB CMR at the same frequency.
...
CMR is measured in decibels and tells you how much common-mode noise is canceled at the load. 40 dB CMR means common-mode noise is reduced by a factor of 100. 50 dB CMR means a factor of about 316. The difference between 40 and 50 dB is perceptually about half as much hum at the output for the same input noise, which is a meaningful improvement on a quiet stage but inaudible on a loud one. In a worship context, where the room goes truly silent between songs, that difference matters more than it would at a rock club.
...
<FAQ questions={[
  ...
  },
  {
    ...
    a: "No. The output is still 120 V phase-to-phase; it just runs through a centered ground reference. All standard gear designed for 120 V will run normally on balanced power. The only caveat is that some older gear with poorly designed power supplies can exhibit slightly different noise characteristics, but there's no damage risk."
  },
  {
...
<SaveThisTone title="Diagnose your rig's noise problem before you buy a conditioner" description="Our preset library has a printable noise-floor diagnostic checklist with five tests that identify whether your rig needs a Hum X, a transformer DI, a standard conditioner, or balanced power. Run the checks before you spend $2,000." href="/recipes/rig-noise-diagnostic-checklist" ctaLabel="Get the diagnostic checklist" />
