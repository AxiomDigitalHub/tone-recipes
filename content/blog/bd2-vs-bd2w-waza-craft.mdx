...
seo_title: "Boss BD-2 vs. BD-2W Waza Craft: Which Suits You?"
description: >-
...
| **Clipping type** | Uneven clipping (sounds more natural) | Near-identical to BD-2 | Modified component values; softer, warmer clipping character |
...
The short version: if you're boosting into a cranked amp, save your money and buy the standard BD-2. If the BD-2 IS your drive sound, the Waza Custom mode is worth hearing.

---

## What Is the BD-2 Actually Doing?

The Boss Blues Driver has been a confusingly named pedal since 1995. It's called a Blues Driver but it's got more gain than you'd expect from a blues pedal, and it behaves more like a dirty boost than the classic blues overdrive sound. Put it next to a TS808 and the difference is stark: the TS has a pronounced midrange hump, softer clipping, and a compressed feel. The BD-2 has a flatter frequency response, wider gain range, and a brightness that doesn't appear in most tube-based overdrive circuits.
...
Custom mode is where the BD-2W earns its price. Boss changed the internal components to produce a different harmonic character. The clipping is uneven, which is why it sounds more natural, and the whole circuit responds differently to pick dynamics.
