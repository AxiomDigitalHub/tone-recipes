...
seo_title: "Vox AC30 Settings: From Jangle to Crunch"
description: >-
  Exact AC30 settings for clean jangle, classic crunch, Brian May-style breakup,
  and Sunday morning worship tone, plus what the reverse-acting Cut control
  actually does.
date: '2026-04-04'
updated: '2026-07-10'
author: Nathan Cross
...
tags:
  ...
  - settings-guide
readingTime: 10
image: /images/blog/vox-ac30-settings-guide.jpg
image_alt: a composition illustrating "Vox AC30 Settings"
---

> **Start Here: Five Things to Know Before You Touch a Single Knob:**
> - The AC30 is cathode-biased with no negative feedback — the famous "Class A" design. It compresses differently than a Fender or Marshall, and that compression is part of the tone
> - There are two channels: Normal and Top Boost. Top Boost adds Bass and Treble controls; Normal is a plainer, volume-only voice
> - The Treble (Top Boost) control is sensitive past about 2 o'clock. It goes shrill quickly
> - The Cut control is a master high-frequency roll-off that works in reverse (turning it up removes treble), not a tone control. It's one of the most useful tools on the amp and gets ignored constantly
...
The AC30 is the amp everyone calls "Class A" — technically it's a cathode-biased push-pull design with no negative feedback, which measures closer to Class AB, but the feel the marketing term points at is real. The four EL84s idle hot, the cathode bias compresses early, and the lack of negative feedback leaves the output stage loose and touch-responsive, contributing a quality that gets described as "alive" or "tactile." What it actually means in practice is that the amp responds to your picking dynamics in a way that feels physical, not electronic.
...
- **Volume:** Same function as Top Boost volume: output and compression. That's the whole channel — no Bass, no Treble. Its brightness is shaped by which input you use and by the master Cut control below.

**Global:**

- **Cut:** This is the counterintuitive one. The Cut is a high-frequency roll-off in the power amp, not a standard tone knob: turning it clockwise removes treble, and rolling it counterclockwise lets the most treble through. If you're used to Fender or Marshall tone controls, your instincts will steer you wrong here. Most players ignore it. That's a mistake. The Cut control is one of the most practical tools on the AC30; it lets you tame a harsh room, compensate for a bright guitar, or dial in the amp to a particular cabinet. Think of it as the amp's overall EQ rather than a channel control.
...
|---|---|---|
| Channel | Top Boost | On a vintage six-input AC30 this is the Brilliant channel; its treble lift is part of the sound |
...
For the Smiths' cleaner, drier approach, pull the Volume back slightly to about 10 o'clock and add a chorus pedal in front of the amp. Johnny Marr's tone is noticeably cleaner and more static than The Edge's. It's the AC30's jangle without the compression signature of a higher volume setting.
...
<GearPick name="Captor X" manufacturer="Two Notes" price="~$599" placement="settings_companion" experiment="aff-e1-settings-companion" verdict="How you get Top Boost at 3 o'clock without clearing the building.">
  An AC30 has no master volume, so the crunch settings below are only available at the volume that produces them. A reactive load lets the Class A power section do exactly what this section describes while you decide how much of it reaches the room — and its DI means you can track the real power stage without a mic. It's the box I reach for when I want an actual AC30 power section on a recording; the [reactive load box vs. attenuator guide](/blog/reactive-load-box-vs-attenuator) has the full comparison.
</GearPick>
...
A light overdrive pedal (a Tube Screamer with Drive at about 9 o'clock and Level around 2 o'clock) before the amp will push it into crunch without cranking the Volume control. This is useful in contexts where you need the dynamic range but can't run the amp loud enough to reach natural breakup.
...
**Running the Cut backward.** Players familiar with Fender or Marshall tone controls instinctively turn the Cut knob clockwise for more brightness. On the AC30, that's the wrong direction. Clockwise removes treble. If the amp sounds dark no matter what you do, check this control first.
...
Roughly, but not directly. The digital versions of the AC30 (Line 6 Helix's **Essex A-30** (Top Boost) and **A-30 Fawn Nrm/Brt** (the earlier non-Top Boost circuit's normal and brilliant inputs) models, the Quad Cortex's Vox AC30 Top Boost model, and Softube's well-regarded AC30 plugin) all capture the general character of the amp: the mid-forward voicing, the compressed response, the Top Boost channel's treble sensitivity.
...
The Normal channel is a simpler circuit with a volume control and no EQ of its own; its top end is shaped mainly by the master Cut control (which reduces treble as you turn it clockwise, the opposite of most amps). The Top Boost channel adds an additional gain-and-EQ stage with separate Bass and Treble controls, giving you much more flexibility. Most players use the Top Boost channel as their primary voice. The Normal channel is useful on its own for a darker, more compressed tone, or jumpered with the Top Boost for a fuller combined character.
...
Check two things. First, the Cut control. It's a master high-frequency roll-off that increases as you turn it clockwise; if it's sitting near fully counterclockwise, the amp will be very bright regardless of the Treble setting. Bring the Cut up toward about 9-10 o'clock and see if that addresses it. Second, on a vintage-style six-input AC30, check whether you're plugged into the Brilliant channel. It adds a treble lift that compounds with everything else. If you want less brightness, the Normal channel gives a more moderate starting point.
