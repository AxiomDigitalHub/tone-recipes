...
The Nashville session players I describe in my [Nashville Session Clean: Tele + Compressor](/blog/nashville-session-clean) post are using light-gauge strings, light compression, and a clean amp set slightly hot. That's the entire recipe. Everything else is reduction, not addition.
