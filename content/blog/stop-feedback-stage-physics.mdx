...
description: >-
  Stage feedback has physical causes that a noise gate can't fix. Here's the
  frequency and physics explanation for why feedback happens, and the specific
  techniques that address it at the source.
date: '2026-04-09'
...
image_alt: >-
  a composition illustrating "How to Stop Feedback on Stage Without a Gate (The
  Physics"
---
...
A noise gate stops signal below its threshold. This is useful for preventing feedback buildup while you're not playing. It cannot stop feedback that occurs while you're playing, because the gate is open during signal. Physical and EQ solutions address feedback that occurs during playing.
