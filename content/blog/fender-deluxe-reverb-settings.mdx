...
Line 6 Helix includes a **US Deluxe Vib** model, based on the '65 Deluxe Reverb (there's a sibling **US Deluxe Nrm** for the Normal channel). The parameters map closely to the real amp.
...
The Vibrato channel has a hard-wired 47pF bright cap on its volume pot that the Normal channel lacks — treble bleeds through at lower volume settings — plus a smaller coupling cap that trims a little low end, giving it a slightly brighter, more present voicing. It's also the channel with the Reverb and Tremolo controls. The Normal channel's larger coupling cap passes more lows, producing a warmer, darker tone. Both share the same EQ and power amp.
...
The Deluxe Reverb is also a go-to worship clean — a warmer, American-voiced alternative to the AC30 jangle for Sunday mornings. If that's your context, the [worship guitar tone guide for the Helix](/blog/worship-guitar-tone-helix) shows how to build the full clean-to-lead snapshot set around this kind of amp.
