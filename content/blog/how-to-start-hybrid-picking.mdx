...
seo_title: "How to Start Hybrid Picking: Four Moves"
description: >-
...
<SaveThisTone
  title="Indie recipes in the catalog"
  description="Every recipe in the catalog has the chain, exact settings, and a preset to load."
  href="/browse?genre=indie"
  ctaLabel="See the indie recipes"
/>
