...
title: >-
  ...
  Abroad
seo_title: "50Hz vs. 60Hz: Mains Frequency and Vintage Amps"
description: >-
  Get the voltage right abroad and a vintage amp can still run hot. The reason
  is mains frequency: 50Hz pushes an old 60Hz transformer toward saturation.
  What it does over a long set, and when to care.
date: '2026-06-05'
...
image_height: 1024
image_alt: >-
  A vintage blackface tube amp chassis pulled from its cabinet, showing the
  power transformer, next to a voltage converter on a workbench
takeaways:
  - >-
    A power transformer wound for 60Hz runs closer to magnetic saturation on
    50Hz, which means it draws more magnetizing current and runs hotter even
...
faq:
  - q: Does mains frequency affect a tube amp's tone?
    a: >-
      ...
      100Hz. On a vintage amp with tired filter caps, that can mean slightly
      more hum and more heat over a long set, which affects reliability before
      it affects tone.
  - q: Is 50Hz or 60Hz harder on a guitar amp?
    a: >-
      ...
      60Hz has more headroom in its transformer and runs cooler, so European
      amps in the US are not a concern.
  - q: Will a voltage converter fix the 50Hz problem?
    a: >-
      No. A standard step-up or step-down converter changes voltage only — it
      passes the local mains frequency straight through. A 230V-to-120V
      converter in Europe still gives you 50Hz. True frequency converters exist
      but are large, expensive, and rare on a stage. For most touring, you fix
      the voltage and manage the frequency by not running an old amp hard for
      hours.
  - q: Can 50Hz damage my vintage amp?
    a: >-
      Not suddenly, the way wrong voltage can. 50Hz won't kill an amp in
      seconds; it raises the running temperature of the power transformer and
      stresses old insulation over time. The risk is a long, hot festival set on
      a marginal vintage transformer, not a quick club gig. Keep the amp
      ventilated, don't bury it against a wall, and watch the heat.
