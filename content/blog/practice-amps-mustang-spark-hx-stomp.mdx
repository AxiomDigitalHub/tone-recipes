...
<SaveThisTone
  title="Browse Helix / HX Stomp presets"
  description="Every recipe in our library translated for Helix / HX Stomp — signal chain, exact settings, ready to load."
  href="/browse?platform=helix"
  ctaLabel="Browse Helix / HX Stomp presets"
/>
