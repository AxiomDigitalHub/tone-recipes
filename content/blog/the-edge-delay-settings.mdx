...
image_alt: "A delay pedal and rack unit set up for dotted-eighth repeats, the core of The Edge's U2 guitar sound"
takeaways:
  - >-
    The Edge's signature sound is a dotted-eighth delay — exactly 75% of one
    beat — so the repeats land between your picked notes and the two interlock
    into a pattern that sounds like twice the notes you actually play.
  - >-
    Calculate the time with 60,000 / BPM × 0.75 (about 375 ms at 120 BPM), or
    set your delay's note division to "dotted 1/8" and tap the quarter-note
    tempo so the unit does the math.
  - >-
    Run a higher wet mix than feels natural — around 40–50% — so the repeats
    act as a second rhythmic voice rather than background echo, with feedback
    set to 3–5 audible repeats.
  - >-
    Roll the top off the repeats (high-cut around 3–4 kHz) and add subtle
    modulation so the echoes sit under the dry signal instead of competing with
    it.
  - >-
    Use less gain than you expect: light crunch or clean keeps each note and
    repeat articulate, while heavy distortion smears the rhythmic pattern into
    mush.
faq:
  - q: What delay setting does The Edge use?
    a: >-
      A dotted-eighth-note delay synced to the song's tempo, with moderate
      feedback (3–5 repeats) and a high wet mix around 40–50%. The dotted-eighth
      timing is the non-negotiable element — it places the repeats between the
      beats so they interlock with the dry notes into a cascading rhythm.
  - q: How do I calculate a dotted-eighth delay time?
    a: >-
      Use the formula 60,000 ÷ BPM × 0.75. At 120 BPM that's 375 ms; at 100 BPM
      it's 450 ms. If your delay has a note-division setting, just choose
      "dotted 1/8" and tap or set the quarter-note tempo, and the delay
      calculates the millisecond value for you.
  - q: Why does The Edge's delay sound so rhythmic instead of just echoey?
    a: >-
      Because the dotted-eighth repeats fall in the gaps between his picked
      notes rather than on the beat. When he plays steady eighth notes, the dry
      notes and the offset repeats combine into what sounds like fast
      sixteenth-note picking — he plays half the notes and the delay fills in
      the rest.
  - q: How much delay mix should I use for an Edge tone?
    a: >-
      Higher than most players are comfortable with — about 40–50% wet, roughly
      1 o'clock on a mix knob. At that level the repeats become a prominent
      second voice. Below about 30% the rhythmic interplay is too subtle to
      produce the interlocking pattern that defines the sound.
---
...
Push the wet mix higher than feels natural. The delay needs to be loud enough that the rhythmic interplay between dry notes and delayed notes is clearly audible. In a band context, this is what creates that layered, enveloping quality, whether on a large stage or a small one. If a mix this high starts to clutter your busier passages, a [ducking delay](/blog/ducking-delay-sidechain-repeats) lets you keep the loud repeats while pulling them down under your playing and letting them swell back up in the gaps — a gentle way to run more wet signal without losing the dry notes.
