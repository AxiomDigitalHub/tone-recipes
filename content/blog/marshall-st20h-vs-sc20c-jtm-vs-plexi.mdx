...
<FAQ questions={[
  {
    ...
    a: "Cost and reliability. KT66s are expensive (about $80 to $120 a pair from current production sources) and the supply is inconsistent. The 5881 is in the same tube family as the KT66 (both are 6L6-derived large-bottle power tubes) and Marshall has decided that the voicing difference is small enough not to justify the upcharge. If you want the period-correct sound, you can swap to actual KT66s without rebiasing because the tube sockets and the bias circuit are designed for the family. Most players who do the swap report a slight smoothing of the upper mids and a slightly slower attack, but it's a subtle change."
  },
  {
    q: "Can I run the ST20H into any cab, or does it need a specific impedance?",
    a: "It has an 8/16-ohm switch on the back, like every other modern Marshall head. It runs into any standard guitar cab. The classic JTM45 pairing was a 4×12 with Celestion G12M Greenbacks, which is what Marshall used on the original 1962 model. The closest small-format equivalent today is a 1×12 SV112 with a Greenback or a 2×12 SV212 with two Greenbacks."
  },
  {
    q: "Which amp sounds better at bedroom volume?",
    a: "The ST20H, by a noticeable margin. The tube rectifier means the amp compresses earlier and more gracefully than the SC20C, so the breakup happens at lower volumes without needing the master volume the Studio amps don't have. At 5 watts in a small room, the ST20H sounds like a JTM45 should sound (sagging, warm, blooming) even at conversation volume. The SC20C at 5 watts is also good, but the Plexi voicing wants more air to feel right; at very low volume it can sound thin where the ST20H sounds full."
  },
  {
    q: "Does the ST20H really not have a master volume?",
    a: "Correct. Neither amp has a master volume, because the original JTM45 and 1959 Super Lead didn't have one. Marshall reproduced the circuits as they were. The 20 W / 5 W switch is the only volume management built in, and on the ST20H the tube rectifier's natural sag does some of the work a master volume would do on a more modern amp. If you absolutely need a master volume, the SV20H Studio Vintage is the JCM800-circuit Studio amp with a master volume built in. That's a different circuit but the same Studio platform."
  },
  {
    q: "Is either amp the right answer for hard rock or metal?",
    a: "Neither, really. The ST20H is too warm and slow for modern hard rock; it's a blues amp at heart. The SC20C is right for classic rock and pedal-pushed hard rock (AC/DC, early Van Halen, Aerosmith) but doesn't have enough native gain for anything heavier. If you want a Marshall in the Studio chassis for hard rock or '80s metal, the SV20H (JCM800 circuit) or the SJ20H (Silver Jubilee circuit) are the right Studio amps. For modern high-gain metal, the JVM410H or a different brand entirely is a better starting point."
  }
]} />
