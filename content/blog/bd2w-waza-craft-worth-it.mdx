...
The standard BD-2 uses an op-amp based clipping circuit. The BD-2W uses 100% discrete transistor components throughout, with no op amps anywhere in the signal path. This isn't marketing language. It's the same choice vintage circuit designers made before integrated circuits became cheap and reliable, and it produces a measurably different response.
...
- **More sustain.** Hold a single note with Drive at noon in Standard mode; it fades naturally. Switch to Custom at the same setting, and the note sustains longer before the decay. This isn't infinite sustain; it's compressed sustain, meaning the gain is working harder to hold the note. If you're playing single-note lines that need to sing, Custom mode makes a clear difference.
...
**Does the BD-2W stack well with other overdrives?**
Yes. Custom mode at low Gain stacks particularly well under a higher-gain drive. Set Gain to 7-8 o'clock and let it add body to whatever comes next in the chain. Standard mode stacks more like the original BD-2, which has been a stacking staple for decades.
