...
seo_title: "Celestion Showdown: G12T-75 vs. V30 vs. Greenback"
description: >-
  The four big Celestion speakers — Greenback, Blue, V30, and G12T-75 — each
  voice an amp differently. Here's what separates them and how to choose or pair
  them.
date: '2026-04-21'
...
image_alt: >-
  Four Celestion guitar speakers — a Greenback, a Blue Alnico, a Vintage 30, and
  a G12T-75 — arranged side by side showing their different cones and magnets
takeaways:
  - >-
    The Greenback is warm with a natural rolloff above 5 kHz; the Blue Alnico is
    chimey with extended highs; the Vintage 30 has an aggressive 1.5–3 kHz
    presence peak; the G12T-75 is neutral with extended bass.
  - >-
    Speaker character is complementary, not additive — pair a neutral amp with a
    characterful speaker (V30, Greenback) and a characterful amp with a neutral
    one (T-75), rather than stacking two upper-mid peaks.
  - >-
    A 4x12 of V30s can build up a fatiguing 2 kHz shout at stage volume; swapping
    two of the four for T-75s tames the peak while keeping some V30 definition.
  - >-
    Wattage sets the breakup ceiling: the 15 W Blue and 25 W Greenback compress
    and break up early and musically, while the 60 W V30 and 75 W T-75 stay tight
    under high power.
  - >-
    Mixing speakers (the "married cab" — one V30, one Greenback) blends both
    voices; the same trick works digitally by blending a V30 IR and a Greenback
    IR on parallel paths.
faq:
  - q: Which Celestion speaker is best for blues?
    a: >-
      The Greenback and the Blue Alnico are the two strongest choices. The
      Greenback adds warmth and midrange body that suits single-note blues lead
      work; the Blue is cleaner and chimier, which works better for clean blues
      platforms. If you're running a medium-gain blues setup through a
      Fender-style amp, the Greenback usually wins. If you're running clean with
      a transparent overdrive into a Vox-style amp, the Blue is more appropriate.
  - q: Can I replace the V30s in my Mesa Rectifier cab with T-75s?
    a: >-
      Yes, and many players do. The standard Rectifier 4x12 loaded with V30s can
      accumulate upper-mid harshness at stage volume with high-gain settings.
      Replacing with T-75s smooths that region. A common alternative is replacing
      only two of the four V30s with T-75s for a mixed cab that retains some V30
      definition while taming the peak.
  - q: What's the difference between the Celestion Blue and the Celestion Gold?
    a: >-
      Both use alnico magnets. The Blue is rated at 15W; the Gold is rated at
      50W, making it suitable for higher-power applications while retaining much
      of the alnico character. The Gold's higher power handling changes its
      break-up threshold and low-frequency behavior slightly; it's less
      compressed at moderate volume than the Blue. For clean applications, the
      Blue's lower wattage rating produces earlier, more musical cone behavior.
  - q: Do IR packs in modelers accurately capture these speakers?
    a: >-
      They capture the speaker's measured frequency response reasonably well, but
      they don't fully replicate the physical behavior of a speaker under load
      (cone breakup, air movement, and room interaction). An IR of a Greenback
      sounds closer to a Greenback than to a V30, and the tonal differences
      between the four are audible in IR form. They're a practical approximation,
      not a perfect substitute.
  - q: Is the Vintage 30 really that fatiguing at loud volumes?
    a: >-
      In a 4x12 configuration at band-rehearsal or stage volume with sustained
      high-gain playing, yes. The 2–3kHz presence peak can become tiring. In
      smaller formats (1x12 or 2x12) or at practice volumes it's much less of an
      issue. Many players who love V30s in the studio find them more aggressive
      live and mix them with neutral speakers for stage use.
---
...
One thing the mixed cab adds that an all-matched cab doesn't: a real choice of *which* speaker to put a mic on. In a married V30/Greenback cab, the speaker you record is the tone decision — V30 for cut, Greenback for warmth — and the rest of the cab is just along for the ride. [Which speaker to mic on a multi-speaker cab](/blog/which-speaker-to-mic-multi-speaker-cab) walks through finding the right one and where to aim the mic once you have.
