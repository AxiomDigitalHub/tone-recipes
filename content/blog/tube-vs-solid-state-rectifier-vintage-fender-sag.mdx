...
faq:
  ...
  - q: Will a solid-state rectifier damage my vintage amp?
    a: >-
      No, if it's the right voltage rating. A Weber Copper Cap or a JJ GZ34 sub
      is a drop-in replacement for any 5AR4/GZ34 socket. What changes is the
      plate voltage — solid-state rectifiers don't drop the 30-50V that a tube
      rectifier does, so your plate voltages will be higher and your tubes will
      run hotter. Have a tech check the bias after the swap.
  - q: Which Fender amps use which rectifiers?
    a: >-
      Generally: Champ and Princeton used 5Y3, Deluxe and Vibrolux used 5U4 or
      5AR4, Super Reverb and Bassman used GZ34/5AR4, Twin Reverb and bigger amps
      used solid-state rectifiers from the mid-1960s onward. Tweed amps mostly
      used 5Y3 or 5U4; blackface amps used GZ34 or moved to silicon.
