...
takeaways:
  - >-
    Always upgrade the overdrive first — it's the pedal you hear most, and the
    difference between a $25 and $59 OD is the most audible single change.
  - >-
    The isolated power supply is the boring upgrade with the largest noise-floor
    impact — half the noise on a budget board is the daisy chain.
  - >-
    Replace the delay third (budget digital delays have audible quantization on
    long repeats); replace the reverb last (cheap reverb is the most-acceptable
    cheap pedal).
  - >-
    Replace the velcro-on-plywood board around $200 in upgrades — the board
    itself causes intermittent connection problems that masquerade as tone
    problems.
  - >-
    Skip the tuner and compressor upgrades until past $500 in budget — those are
    workflow improvements, not tone improvements.
faq:
  - q: Why upgrade the overdrive before the reverb?
    a: >-
      Because you hear the overdrive on every song, and the difference between a
      $25 overdrive and a $59 overdrive is noticeable. The reverb you only
      really hear on the tail of notes, and the difference between a $25 reverb
      and a $129 reverb is much smaller in mix. Per-dollar tone improvement, the
      overdrive upgrade is the most impactful change you can make on a budget
      board.
  - q: >-
      Is the Donner DP-3 isolated power supply actually isolated, or is it a
      marketing claim?
    a: >-
      It's actually isolated — I tested it with a multimeter on each output and
      confirmed the grounds are independent. Donner's product page makes the
      right technical claim and the product delivers it. The build quality isn't
      premium (plastic chassis, no thermal regulation specs, shorter expected
      lifespan than a Voodoo Lab Pedal Power 2 Plus), but the basic
      isolated-output functionality is real and meaningful for noise reduction.
  - q: 'Should I upgrade my whole pedalboard at once, or do it in stages?'
    a: >-
      Stages. Two reasons: first, you can't tell which upgrade made the biggest
      difference if you change everything at the same time. Second, gradual
      upgrades let you sell each replaced pedal on Reverb to fund the next
      upgrade. The Behringer SF300 sells for $15-20 used, the daisy chain sells
      for $10, the DD400 sells for $20-25. That recovered money buys you most of
      the next upgrade.
  - q: >-
      What if I have a different starter board than the $300 build you
      described?
    a: >-
      The principles still apply. Identify your overdrive — if it's under $40
      new, replace it first. Identify your power source — if it's a daisy chain,
      replace it second. Identify your delay — if it's a budget digital delay
      with audible artifacts, replace it third. The reverb and tuner go last
      regardless of starter board because they're the pedals where budget
      compromises are most acceptable.
  - q: When should I think about upgrading the amp instead of more pedals?
    a: >-
      Once your pedalboard total is around $500-$600, the marginal tone
      improvement from another pedal upgrade is smaller than the marginal
      improvement from an amp upgrade. If you're playing through a $99 practice
      amp, even a $300 amp upgrade (Boss Katana 50, Fender Champion 40, Vox
      Pathfinder 15) will move your tone more than another $200 of pedals. The
      amp is your output stage; once your input chain is clean, the output stage
