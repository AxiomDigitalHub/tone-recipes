...
seo_title: "Drop-Tuned High Gain, Frequency by Frequency"
description: >-
...
<EQCurve
  title="Post-EQ shape — tight low end, cut fizz"
  bands={[
    { freq: 100, gain: -2 },
    { freq: 220, gain: -1.5 },
    { freq: 5000, gain: -2 },
...
<FAQ
  questions={[
    {
      q: "Why do my palm mutes sound tight when I'm alone but loose in a mix?",
      a: "The mix context exposes low-end issues that aren't obvious in isolation. Bass guitar occupies the same frequency range as your drop-tuned guitar's low strings. Without EQ correction, your guitar and bass will compete for the same frequency range and both will sound worse. Cut the guitar more aggressively at 100–200 Hz than you think you need to when recording. You'll get it back in the mix.",
    },
    {
      q: "Do I need a different signal chain for each tuning?",
      a: "Yes, if you regularly switch between tunings. A preset optimized for standard E will sound flabby in drop A and vice versa. Keep separate presets by tuning and label them clearly. The EQ corrections are tuning-specific.",
    },
    {
      q: "Does a higher-output pickup fix the low-end buildup problem?",
      a: "No. Higher output pickups often make it worse by driving the amp's gain stage harder with more low-frequency content. The solution is EQ, not pickup output.",
    },
    {
      q: "My drop-tuned high-gain preset sounds great in headphones but muddy through a cab. Why?",
      a: "Headphone monitoring reproduces the full frequency range with flat response. A guitar cabinet has resonant characteristics that boost certain frequencies — particularly the 80–120 Hz range for most guitar speakers. A preset calibrated on headphones will have more low-end buildup than expected through a physical cab. Apply additional low-frequency cuts when testing through a cab.",
    },
  ]}
/>

<SaveThisTone
  title="Start your drop-B high-gain preset"
  description="Open the library to the Helix Fortin NTS-style high-gain starters, or load any drop-tuned recipe and tweak the EQ curves above to match your rig."
