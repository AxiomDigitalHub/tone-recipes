...
seo_title: "Khruangbin Tone on an HX Stomp: Clean Funk for $299"
description: >-
...
**Into a power amp and cab (no amp sim):** Disable the cab block and send the output directly to a power amp into a guitar cab. The tone will be brighter and more present than through studio monitors, so compensate by pulling the amp Treble to 4.5 and the High Cut out of the cab block (since there's no cab block). The spring reverb's High Cut at 5.5kHz becomes more important, not less.
