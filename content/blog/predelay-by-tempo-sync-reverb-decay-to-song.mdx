...
takeaways:
  - >-
    Predelay is the silent gap between your note and the start of its reverb. Set
    it to a rhythmic subdivision of the song's tempo and the reverb enters in
    time with the groove instead of smearing across it.
  - >-
  ...
  - >-
    Decay should clear before the next chord change, not ring through it. Aim the
    tail to fade across roughly one bar for slow songs and a half bar for faster
    ones, so the reverb resets instead of piling up into mud.
  - >-
...
faq:
  ...
  - q: Does predelay make the guitar sound bigger or farther away?
    a: >-
      Both, and they are different. A short predelay glues the reverb to the note
      and the guitar sits farther back in the mix. A longer predelay separates
      the dry note from its reverb, keeping the note forward and intelligible
      while the space opens behind it. That separation is how you get a huge
      reverb without burying the part.
