...
seo_title: "A DIY Buffered, Isolated Splitter for Under $80"
description: >-
...
faq:
  - q: Why put a buffer and a transformer in the same box?
    a: >-
      ...
      one guitar signal can drive three cables without losing high end or level.
      The transformer galvanically isolates one output so there is no shared
      ground path between your amp and the front-of-house system, which is what
      kills the hum a buffer alone leaves behind. Together they give you a
      strong, quiet three-way split.
