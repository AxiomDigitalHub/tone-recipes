...
seo_title: "Solid-State Amps Worth Owning in 2026"
description: >-
...
The JC-120's clean tone is very present and focused by default; it can feel harsh if you're coming from a warm tube clean. Lower the Treble from the stock position and add a very small amount of Bass. The internal chorus adds stereo width without the pitch-shift artifacts that chorus pedals sometimes introduce, so don't be afraid of it.
...
**About the Feel/Texture dial:** The Feel/Texture dial genuinely changes how the amp responds to picking dynamics in a way that doesn't feel like an EQ change or a gain change. It's a different physical sensation. Whether it's "like a tube amp" is debatable; it's its own thing. But it's not a normal solid-state response.
