...
<SaveThisTone
  title="Browse Katana presets"
  description="Every recipe in our library translated for Katana — signal chain, exact settings, ready to load."
  href="/browse?platform=katana"
  ctaLabel="Browse Katana presets"
/>
