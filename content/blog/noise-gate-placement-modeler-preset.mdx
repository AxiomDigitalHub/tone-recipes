...
seo_title: "Noise Gate Placement in a Modeler Preset"
description: >-
  Where to put the noise gate in a Helix or Quad Cortex high-gain preset. Keying
  off the raw guitar versus gating after the amp, with the timing data on why
  each placement chatters or smears.
date: '2026-05-29'
...
takeaways:
  - >-
    A gate placed first, keyed off the raw guitar, tracks palm mutes the fastest
    because the clean signal has the clearest transients. This is the default
    placement for tight, chugging high-gain.
  - >-
...
faq:
  - q: Where should I put the noise gate in a Helix or Quad Cortex preset?
    a: >-
      ...
      raw guitar signal, which has the clearest note-on and note-off transients.
      This tracks palm mutes the fastest. If you still have amp hiss with the
      gate open, add a second gate after the amp block but before any reverb or
      delay. Never put a gate after a time-based effect, because it will chop
      the tails.
  ...
  - q: Is a gate after the amp better than a gate before it?
    a: >-
      ...
      and a post-amp gate for hiss, each set gently so neither does all the
      work.
