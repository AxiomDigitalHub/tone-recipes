---
title: 'Transformer-Isolated vs Active Buffered Splitters: When the Ground Loop Forces the Upgrade'
description: >-
...
faq:
  - q: Do I need a transformer-isolated splitter or is a buffered one enough?
    a: >-
      ...
      clears the hum. You need a transformer only when the amp and front-of-house
      are on different circuits, because that voltage difference creates a true
      ground loop that a lift alone will not silence. The transformer physically
      breaks the loop.
  ...
  - q: What is the phase switch for on a splitter or DI?
    a: >-
      ...
      end in the house mix. Flipping the phase switch puts them back in agreement.
