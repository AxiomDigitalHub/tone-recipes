...
readingTime: 5
image: "/images/blog/fix-thin-modeler-tone.jpg"
image_alt: "A modeler interface with five key settings highlighted to fix a thin, weak guitar tone"
---
...
|---|---|
| [*Helix*](/platforms/helix) | Signal chain view — look for the Cab block after the Amp block |
| [*Quad Cortex*](/platforms/quad_cortex) | Node graph — cab node should be active (solid outline, not grayed) |
