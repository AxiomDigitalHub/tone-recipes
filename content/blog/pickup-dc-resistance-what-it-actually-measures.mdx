...
faq:
  ...
  - q: Can I compare DC resistance between a single-coil and a humbucker?
    a: >-
      ...
      pair of small coils to one large one. Their inductances are not comparable
      either.
image: /images/blog/pickup-dc-resistance-what-it-actually-measures.jpg
image_alt: >-
  A digital multimeter with test probes beside an electric guitar on a dark
  workbench, an unmounted single-coil pickup and a spool of fine copper wire
  next to it, neon signs glowing in the background
---
