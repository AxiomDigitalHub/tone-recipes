...
seo_title: "Boss DS-1 Settings for Every Style"
...
image_alt: "A Boss DS-1 distortion pedal with knob positions marked for punk, grunge, classic rock, and metal"
---
...
The DS-1's Tone control, when pushed above noon, starts emphasizing a frequency range that is genuinely unpleasant: an upper-midrange and low treble harshness that sits badly in a band mix and clashes with amp resonances. It's not subtle. It's the thing people mean when they say the DS-1 sounds "fizzy."
...
**Amp pairing:** A clean amp with a relatively flat EQ response, like a Fender-style combo or a solid-state amp pushed reasonably hard. Punk doesn't require a lot of amp gain; the DS-1 provides the character. A slightly dirty amp works too, but the gain stacking can make the low end flabby.
...
**Amp pairing:** A British-voiced amp at edge of breakup, like a Marshall, a Vox, or a modeler running either. The DS-1 at low Dist into a slightly driven amp is additive: the pedal adds sustain and upper harmonic content, the amp adds its own warmth and compression, and the combination is denser than either one alone. See the [signal chain order guide](/blog/signal-chain-order-guide) for placement details.

**Guitar note:** Single-coil guitars (Strats, Telecasters) have extra brightness at low Dist settings. Keep the Tone at noon or just below. Humbuckers can take Tone up to about 1 o'clock without the harshness becoming a problem, since the humbucker's natural frequency rolloff compensates.
