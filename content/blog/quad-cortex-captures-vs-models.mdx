...
image_alt: "A Neural DSP Quad Cortex screen comparing a Capture against a built-in amp model"
---

## Two Tools, Two Architectures

The [Quad Cortex](/platforms/quad_cortex) gives you two fundamentally different engines for producing amp tones: **models** and **captures**. They both live in the same signal chain grid, they both sound great, but they work in completely different ways under the hood. Understanding the architectural difference changes how you build presets.
...
1. **Start with models when [building a new preset](/blog/quad-cortex-preset-from-scratch).** The ability to tweak every parameter makes models faster for [dialing in a starting point](/blog/how-to-dial-in-modeler-tone). Once you've found a tone you like, consider capturing a real amp to match it, or just keep the model if it's working.
