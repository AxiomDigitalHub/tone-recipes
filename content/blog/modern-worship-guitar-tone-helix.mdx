...
One thing worth noting with this combination: running the reverb's low cut relatively high (around 120 Hz rather than the typical 80 Hz) clears up the low end of fast chord changes dramatically. The reverb tail's low frequencies were interfering with the next chord's attack. This small adjustment made the whole foundation feel tighter and more intentional.
