...
image_alt: "A guitar rig with grounding and shielding fixes highlighted to remove 60-cycle hum without a noise gate"
---
...
**The touch test.** Plug in, turn the amp up until you hear noticeable hum, then touch the metal bridge or strings.

- **Hum drops or disappears** → Your guitar's ground path is working. Your body, acting as an antenna picking up ambient 60 Hz, just got shunted to earth through the guitar's ground circuit. This is the normal, healthy result.
- **Hum stays the same or gets louder** → The ground path inside the guitar is broken. With the bridge-ground wire disconnected, the strings are floating; touching them couples your body's 60 Hz interference *into* the pickup circuit instead of shunting it away. That's the diagnostic signature of a bad guitar ground.

**The fix:** Open the guitar's control cavity. Look for a wire running from the bridge saddle or bridge post cavity to the back of a pot or the jack. This is the ground wire. Check that it's soldered at both ends. If it's disconnected, re-solder it. Cold solder joints (dull, crumbly, grey) should be re-flowed. This is a simple repair: ten minutes and a soldering iron.
...
1. Touch the strings. **Hum stays the same or gets louder?** → Broken ground inside the guitar. Fix the ground wire. (If the hum *drops*, the guitar's ground is working; that's the good result.)
