...
seo_title: "String Pings at the Nut: A Diagnostic"
description: >-
...
takeaways:
  - >-
    A ping when you tune is a string binding in the nut slot — it sticks,
    tension builds behind it, then it releases all at once and the pitch jumps
    past where you wanted it.
  - >-
  ...
  - >-
    ...
    you jump from 9s to 10s or 11s without recutting — or a rough slot bottom
    that drags. Widen or polish, don't just smear pencil lead in it.
faq:
  - q: Why does my guitar string ping when I tune it?
    a: >-
      ...
      until it overcomes the friction and releases in one jump — that's the
      ping, and the tuner needle leaping past your target pitch is the proof.
      It's a friction problem in the slot, not a sign your nut is ruined.
  - q: Is the ping coming from the nut or the tuner?
    a: >-
      ...
      culprit. If it still pings, the sticking point is upstream at the tuner
      post or the string tree, and lubricating the nut won't do a thing.
  - q: Will graphite or nut lube fix a pinging nut?
    a: >-
      Only if the slot geometry is already correct. Pencil graphite and
      dedicated nut lubricants lower the friction in a slot that's the right
      width and smooth on the bottom. If the slot is too narrow for the string
      or rough from a file, lube buys you a few days and then the ping returns.
      Lubricant is the last step after the fix, not the fix.
  - q: Why is it always my G string that pings?
    a: >-
      ...
      instead of riding on the ridges of a winding. It also sits in a slot
      that's often cut a hair too narrow. That combination makes the G the first
      string to ping and the most common one players complain about.
  - q: Can a nut slot be too tight after a string gauge change?
    a: >-
      ...
      will pinch a .018 or larger when you move up a gauge, and the heavier
      string binds every time you bend or tune. Going from 9s to 10s or 11s
      without recutting the slots is a frequent cause of new ping after a string
      change.
---
