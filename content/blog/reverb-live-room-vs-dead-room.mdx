...
Outdoors is essentially a perfectly dead room with no reflections at all, just open air. Use generous reverb settings (close to the dead room column in the table) and expect the sound to feel drier and more immediate than any indoor setting. Pre-delay matters less outdoors because there's no room ambience for the note to blend into.
