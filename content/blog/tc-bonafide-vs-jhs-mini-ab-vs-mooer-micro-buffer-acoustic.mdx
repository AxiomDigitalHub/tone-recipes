...
seo_title: "Three Acoustic Buffers Compared: TC, Mooer, JHS"
description: >-
...
image_alt: >-
  TC Electronic BonaFide, Mooer Micro Buffer, and JHS Mini A/B pedals lined up
  on a small acoustic gig pedalboard
takeaways:
  - >-
...
faq:
  - q: Do I need a buffer for my acoustic guitar?
    a: >-
      ...
      battery, that preamp is already buffering the signal and you do not need
      an extra pedal.
  - q: Is the JHS Mini A/B a buffer?
    a: >-
      ...
      cable or restore lost top end. If you bought one expecting it to fix a
      thin acoustic tone, it will not, because there is nothing inside it to do
      that job. You want an actual buffer like the TC BonaFide or the Mooer
      Micro Buffer instead.
  - q: TC BonaFide or Mooer Micro Buffer for acoustic?
    a: >-
      ...
      dollars of each other, so it comes down to whether you want flat or a
      touch of sparkle.
