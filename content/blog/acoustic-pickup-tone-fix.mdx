...
title: >-
  ...
  the Tone
seo_title: "Acoustic Pickup Tone: Five Frequency Fixes"
description: >-
  An acoustic through a piezo or magnetic pickup sounds quacky, brittle, and
  thin. Five specific EQ moves fix it for free — before you buy a DI box. Here's
  the curve.
date: '2026-04-25'
updated: '2026-06-26'
author: Dev Okonkwo
...
takeaways:
  - >-
    An acoustic pickup isn't a microphone — it reads bridge pressure or string
    magnetism, so its frequency content is fundamentally shifted from the sound
    in the room, and that's why it sounds wrong by default.
  - >-
    Most of the "this doesn't sound like an acoustic" complaint is one move:
    cut the piezo quack 3–5 dB with a narrow Q around 2.5–3 kHz. That cut alone
    does the heavy lifting.
  - >-
    The full fix is five EQ moves — cut quack (2.5–3 kHz), tame brittleness
    (6–8 kHz), add body (150 Hz), cut boxiness (400 Hz), add air (12 kHz) — and
    the order matters: cut before you boost.
  - >-
    For recording, stock DAW EQ gets you 80–90% of the way for free; dedicated
    acoustic preamps mainly add feedback control and mic modeling (the Fishman
    Aura's convolution), not better EQ.
  - >-
    If your acoustic-electric has an active onboard preamp and suddenly goes
    weak or farty, rule out a dead 9V battery before you touch the EQ — a sagging
    battery mimics a tone problem.
faq:
  - q: Will these EQ settings work for my acoustic guitar?
    a: >-
      The frequency targets are good starting points but should be adjusted by
      ear. The exact center of the quack varies by pickup and guitar — sweep
      with a narrow boost (4 dB at Q 6) and find the most offensive peak, then
      cut there. The 100–200 Hz boost frequency depends on body size; smaller
      guitars resonate higher, dreadnoughts and jumbos lower.
  - q: Why does my acoustic sound okay through an amp but bad through an interface?
    a: >-
      Acoustic amps (LR Baggs, AER, Fishman Loudbox) have built-in EQ shaping
      tuned for piezo pickups — the amp is doing the same five-fix job you'd do
      manually in a DAW. When you bypass the amp and go straight to an
      interface, you lose that shaping. The fix is to recreate it in software.
  - q: Should I use a microphone instead of the pickup?
    a: >-
      When you can. A small-diaphragm condenser (Røde NT5, AKG C451, Shure SM81)
      about 12 inches from the 12th fret captures the guitar far more accurately
      than any pickup. The downsides: it needs a quiet room and a stable stand,
      and it's unusable while moving. For sit-down bedroom recording the mic
      wins; for everything else, pickup-plus-EQ is more practical.
  - q: Do magnetic soundhole pickups need different EQ than piezo?
    a: >-
      Yes, somewhat. Magnetic soundhole pickups have a peaked midrange (around
      1.5 kHz) and don't have the 2–4 kHz quack of piezos, so the Fix 1 cut may
      not be needed. The Fix 3 body boost matters even more because magnetic
      pickups capture even less body resonance. The Fix 4 boxiness cut is
      usually still relevant.
  - q: Can I use these EQ settings as a preset for live performance?
    a: >-
      Yes. Most acoustic preamps and many digital pedals save EQ presets that
      approximate this curve — the Boss AD-10 has built-in presets that hit
      similar targets. You can also build the EQ on a Helix or HX Stomp with the
      parametric EQ block, save it as a patch, and use it for live
      acoustic-into-PA. The five-fix approach translates directly to live use.
---
...
Before you reach for the EQ, there's one failure that masquerades as a tone problem: a dying 9V. If your acoustic-electric has an active onboard preamp — most undersaddle systems with a built-in EQ do — that preamp runs on a battery, and as the voltage sags the output goes weak, thin, and slightly distorted on hard strums. It reads exactly like a bad pickup or a brittle interface input, and you'll waste an afternoon chasing frequencies that aren't the problem. Swap in a fresh battery first. If the weak, farty quality clears, the EQ below is for fine-tuning a healthy signal, not rescuing a starved one. The full story on how long those batteries last and what fails when they drain is in [living with a 9V in your guitar](/blog/onboard-9v-battery-active-electronics-life-management).
