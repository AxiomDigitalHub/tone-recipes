...
title: >-
  ...
  Amps
seo_title: "Wet/Dry/Wet on a Budget: A Three-Output Splitter"
description: >-
  A wet/dry/wet rig means three amps, three grounds, and a hum waiting to
  happen. Build a fully-isolated three-output splitter for the price of one
  boutique box — and why the cheap transformers hold up.
date: '2026-06-05'
...
takeaways:
  ...
  - >-
    You can build the whole thing for roughly the price of one boutique
    splitter, around $90 to $120 in parts, versus $300-plus for a finished
    three-output isolated unit.
  - >-
...
faq:
  ...
  - q: Do all three outputs need to be isolated?
    a: >-
      No. You only need to break the extra ground paths. The standard approach
      is to leave one output (your dry center amp) buffered but not isolated,
      and transformer-isolate the two side (wet) amps. That gives each side amp
      a single path to ground and kills the loops. Isolating all three works
      too, but two transformers is usually enough.
  ...
  - q: Can't a modeler just do wet/dry/wet internally?
    a: >-
      ...
      other, no splitter and no ground loops. The DIY splitter is for players
      who want three real amps moving real air, which the in-the-box version
      can't replicate.
---
