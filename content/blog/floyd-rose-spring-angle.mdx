...
seo_title: "Floyd Rose Spring Angle: Diagonal vs. Parallel"
description: >-
...
4. Tighten the claw screws evenly, check that the bridge is level (parallel to the body), and retune. The springs are part of the tension system, so any position change will shift string pitch.
