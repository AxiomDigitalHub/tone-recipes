...
tags: ["delay", "tone-tips", "troubleshooting", "effects", "quick-fix", "pedalboard", "two-guitarists"]
readingTime: 5
takeaways:
  - >-
    Muddy delay is a low-frequency problem. Each repeat carries the same bass
    content as the dry note, and that content decays more slowly than the treble
    does, so it stacks while the highs fade.
  - >-
    Put the high-pass on the delay signal only. Filtering your whole tone makes
    the guitar thin. Filtering just the repeats leaves the dry note grounded and
    lets the echoes sit above it.
  - >-
    The filter frequency should follow the part, not a fixed number. A 150 Hz
    low cut does nothing for a figure played on the D and G strings, where the
    fundamentals already sit above 150 Hz and the mud is in the lower mids.
  - >-
    Fifteen to twenty-five milliseconds of pre-delay separates the repeat from
    the note perceptually, often before you touch a filter at all.
  - >-
    If there are two guitarists in the room and both run delay at the same
    subdivision, no filter setting will fix it. That mud is an arrangement
    problem wearing an EQ costume.
faq:
  - q: Why does my delay sound fine at home but muddy at rehearsal?
    a: >-
      Room acoustics amplify the low-end buildup in delay repeats. At home, the
      small room absorbs some of that low-end reflection. In a rehearsal space
      with harder surfaces and more volume, the low frequencies from the repeats
      compound with the room's natural resonance. The fix is the same, but you
      may need to set the filter higher, around 200 to 250 Hz, in a livelier
      room.
  - q: Does the type of delay, analog or digital, affect mud?
    a: >-
      Yes, though not in the way most players expect. Analog delays and
      analog-voiced digital delays roll off high frequencies on each repeat.
      That gives them their character. But the roll-off does not touch the low
      end, so an analog delay can actually be muddier than a clean digital delay
      if the filter settings are not adjusted. A high-pass helps both.
  - q: My delay has a Tone knob but no separate high-pass. What do I do?
    a: >-
      A single Tone knob on most analog-style delays cuts highs when turned
      counterclockwise, so opening it up helps slightly. But you still need to
      address the low end. Place a graphic or parametric EQ after the delay with
      a high-pass around 150 to 200 Hz. On a modeler, add an EQ block after the
      delay block and use its low cut parameter.
  - q: How is a high-pass on the delay different from one on my whole tone?
    a: >-
      This is the critical distinction. A high-pass on your whole signal removes
      low end from the dry guitar, which makes everything sound thin and hollow.
      A high-pass on the delay affects only the repeats, leaving your dry signal
      full and grounded. That selective filtering is the difference between a
      guitar that sounds complete and one that sounds small.
  - q: Should every delay have a high-pass filter engaged?
    a: >-
      For most live and full-band playing, yes, at least a gentle one. The
      exception is a solo or textural context where the delay is meant to fill
      low-frequency space and no other instrument is competing for it. Even
      then, a subtle high-pass keeps the repeats from stacking into incoherence
      over time.
  - q: Both guitarists in my band run delay. Why is it still muddy?
    a: >-
      Because two delays at the same subdivision and tempo interleave their
      repeats into a continuous wash, and filtering makes that wash brighter
      without making it any more legible. One player should carry the rhythmic
      delay and the other should carry sustain, reverb, or nothing at all. That
      is an arrangement decision, not a pedal setting.
image: "/images/blog/why-delay-sounds-muddy.jpg"
image_alt: "A delay pedal on a pedalboard with the tone and feedback controls in focus, cables running off frame toward an amp"
---
...
| Where the part lives | Lowest fundamental, roughly | Start the low cut around |
|---|---|---|
| Open chords, low E and A strings | 82 to 110 Hz | 120 to 150 Hz |
| Power chords, D and A strings | 110 to 150 Hz | 150 to 180 Hz |
| Triads on the D, G, B strings | 150 to 250 Hz | 200 to 260 Hz |
| High voicings above the 7th fret | 250 to 400 Hz | 300 to 350 Hz |
| Single-note melody, top two strings | 300 Hz and up | 350 to 400 Hz |
...
The full breakdown of splitting parts between two players is in [two guitarists, one frequency range](/blog/two-guitar-arrangement-register-split). The short version, for the purposes of this article: if the room got muddy the week a second guitarist joined, start there and not here.
