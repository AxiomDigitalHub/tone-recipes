...
seo_title: "Helix Cab Models Decoded: Every Stock Cabinet"
description: >-
  Helix cab names are fictionalized — "4x12 Brit T75" won't tell you what's
  inside. Here's every stock Helix cab mapped to its real cabinet, speaker, and
  best amp pairing.
date: '2026-04-20'
...
image_alt: >-
  A Helix cab block selection screen alongside the real-world guitar cabinets
  and Celestion speakers each model name actually represents
takeaways:
  - >-
    Helix cab model names are fictionalized to dodge trademarks, so "4x12 Brit
    T75" or "2x12 Wishbook" tell you nothing — the display name rarely matches
    the real enclosure inside.
  - >-
    The four Marshall-style 4x12 cabs split cleanly by speaker: Greenback 25 for
    1970s rock, Brit T75 for the scooped JCM800 era, Brit V30 for most high-gain,
    and Recto for Mesa-voiced metal.
  - >-
    The 2x12 Wishbook (AC30 with Celestion Blue alnico) is the non-negotiable
    pairing for any Vox-style amp model — swap the cab and you lose most of the
    chime that makes a Vox a Vox.
  - >-
    Mic choice inside the cab block matters as much as the cab: a 57 off-axis or
    a 121 ribbon tames high-gain fizz, while a 414 condenser adds air to
    single-coil cleans.
  - >-
    Stock cabs are accurate enough for most presets; reach for third-party IRs
    only when you need a specific studio reference, more mic options, or a
    different cab variant.
faq:
  - q: What is the best Helix cab for metal?
    a: >-
      4x12 Brit V30 (Marshall with Celestion V30s) or 4x12 Recto (Mesa cabinet
      with V30s) are the standard choices. The Brit V30 tends to work better with
      British high-gain models; the Recto pairs more naturally with Mesa-style
      amp models. Start with Brit V30 and A/B with Recto if you want a second
      opinion.
  - q: What Helix cab should I use for blues?
    a: >-
      4x10 Tweed Bass (Fender Bassman) for that open American bite, or 4x12
      Greenback 25 (Marshall Greenbacks) for a warmer British response. For
      Deluxe Reverb-style clean blues, 1x12 US Vintage (Fender Princeton) gets
      closest to the open-back character.
  - q: What is the 2x12 Wishbook based on?
    a: >-
      The Vox AC30 2x12 cabinet loaded with Celestion Blue alnico speakers. If
      you're building a Vox-style preset, this is the correct cab. The alnico
      magnet character of the Blue is a significant part of the AC30's chime.
  - q: Should I use Helix stock cabs or third-party IRs?
    a: >-
      The stock cabs are solid and accurate for practical use. Third-party IRs
      offer more mic variety and cab variants, which matters if you have a
      specific studio reference sound in mind. For most preset building, start
      with stock cabs and only reach for third-party IRs if the stock versions
      aren't hitting the target.
  - q: What is the 4x12 Hiway based on?
    a: >-
      The Hiwatt SE4123HW 4x12 loaded with Fane Crescendo speakers. The Fane
      speaker is a significant part of the Hiwatt clean tone: open, detailed, and
      full without the chime of alnico or the aggression of G12T-75. Pair it with
      the Hiwatt amp model for the David Gilmour / Pete Townshend reference tone.
---
...
### For Worship AC30 Tones (Chime vs. Wash)
Modern worship guitar is built on the AC30, but the cab choice splits it into two families. Pair the AC30 amp model with a **Celestion Blue alnico** 2x12 for chime — the bright, sparkling, edge-of-breakup voice behind tones like [What a Beautiful Name](/blog/what-a-beautiful-name-guitar-tone-helix) and [Way Maker](/blog/way-maker-guitar-tone-helix). Swap to a **G12M Greenback** 4x12 for a warmer, woollier wash that sits under a dense mix without turning into an ice pick — the voice behind [Goodness of God](/blog/goodness-of-god-guitar-tone-helix). Same amp block, opposite character, and the room can decide which one is right: a full breakdown of when to pick each is in [Alnico Blue vs. Greenback in an AC30](/blog/alnico-blue-vs-greenback-ac30-worship).
...
This table is also your map for re-cabbing a finished take. If you tracked a dry DI, you can [swap any of these cab models onto the recorded part after the fact](/blog/reamp-clean-di-through-cab-sim-pedal) — load the DI on a track, pick the amp model, and audition speakers from this list in real time without re-playing a note.
