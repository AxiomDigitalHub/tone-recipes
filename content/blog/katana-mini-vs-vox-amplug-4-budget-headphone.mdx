...
seo_title: "Katana Mini vs. Vox amPlug 4: Headphone Amps"
description: >-
...
The Katana Mini's tape input is mono and the volume isn't matched to the guitar, so you'll need to set your phone's volume manually relative to the amp's master, and the speaker is small enough that a backing track at meaningful volume can wash out the guitar. This is fine for jamming over chord changes, less fine for working on lead lines where you need the guitar to sit on top of the mix.
...
## What I Actually Use More Often
