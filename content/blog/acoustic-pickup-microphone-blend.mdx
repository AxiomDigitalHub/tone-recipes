...
faq:
  - q: Do I need an expensive condenser microphone to record acoustic this way?
    a: >-
      ...
      up but diminishing returns hit hard above $300 for this. The blend
      forgives a lot of microphone limitation because you're using each source
      for what it does best, not asking either to be the complete picture.
  - q: 'Can I blend a pickup and mic live, not just in the studio?'
    a: >-
      ...
      real mic, but workable where you can't put up a microphone. For a real
      live mic you'll need a feedback-resistant cardioid and careful stage
      volume; pickup-mic blends feed back fast on loud stages. Controlled
      worship stages handle it well, loud rock stages don't.
  - q: What about using only the pickup and faking the body with EQ?
    a: >-
      It's better than nothing, and the pickup-only EQ approach is covered in
      our acoustic pickup tone fix post. But the blend always sounds more
      natural, because you can't generate body resonance from a transient signal
      — the body is exactly what's missing from the pickup, and EQ can't add
      what isn't there. If you have any microphone, even a $99 one, the blend
      wins.
  - q: How do I time-align the pickup if my DAW has no sample-level editing?
    a: >-
      ...
      a delay plugin set to about 2.7 ms on the pickup instead — close enough
      for many sources.
