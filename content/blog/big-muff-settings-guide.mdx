...
<SaveThisTone
  title="David Gilmour presets in the library"
  description="Every David Gilmour recipe we've published — signal chain, exact settings, downloadable presets."
  href="/browse?artist=david-gilmour"
  ctaLabel="Browse David Gilmour recipes"
/>
