...
### `dave-murray-wrathchild-riff` — ⚠ 1 warn
...
### `george-lynch-mr-scary-lead` — ⚠ 1 warn

*George Lynch's Mr. Scary Lead Tone*

**Warnings:**
- `translations-utility-mirror` — quad_cortex missing EQ; fractal missing EQ

### `grohl-monkey-wrench-riff` — ⚠ 1 warn

*Grohl's Monkey Wrench Rhythm Wall*

**Warnings:**
- `translations-utility-mirror` — quad_cortex missing EQ

### `kk-downing-hell-bent-for-leather-riff` — ⚠ 1 warn

*K.K. Downing's Hell Bent for Leather Riff*
...
### `glenn-tipton-beyond-the-realms-clean-to-lead` — ✓ clean

*Glenn Tipton's Beyond the Realms of Death Clean-to-Lead*
