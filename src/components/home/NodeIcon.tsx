...
export default function NodeIcon({
  ...
  switch (label) {
    case "GUITAR":
      // Guitar SVG is tall (aspect ~0.32). Rotated 45° so it fills the
      // tile's diagonal, and scaled so its height is ~90% of the tile
      // size — at that scale the rotated bounding box is roughly equal
      // to the tile size. Much more presence than the prior 0.45/0.7.
      return (
        <svg
