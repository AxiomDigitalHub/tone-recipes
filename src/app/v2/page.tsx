...
export const metadata: Metadata = {
  title: {
    absolute: "Fader & Knob v2 — Guitar Tone Recipes for Every Platform",
  },
  description:
    "Pick a song. Get exact settings for your Helix, Quad Cortex, TONEX, or physical rig. Stop tweaking. Start playing.",
  robots: { index: false, follow: false }, // don't index the v2 preview
};
...
export default function HomeV2() {
  ...
  return (
    <>
      {/* 1 — Hero. No cable, no gradient underline, no signal card jammed in. */}
      <HeroV2 />

      {/* 2 — Signal chain explainer. The chain now has its own block. */}
      <SignalChainShowcase />

      {/* 3 — Featured recipes, moved up so social proof shows quickly. */}
      <ScrollReveal>
      ...
      {/* 4 — Three steps. Simpler than v1: no icon-boxes, just typography. */}
      <ScrollReveal>
      ...
      {/* 6 — Platform onboarding (unchanged) */}
