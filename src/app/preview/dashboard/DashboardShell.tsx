 ...
 *
 * The visual language matches /preview/blog (left sticky sidebar,
 * paper/ink contrast, mono-cap labels, amber active-state border).
 */

const NAV_ITEMS = [
  { href: "/preview/dashboard", label: "Overview" },
  { href: "/preview/dashboard/saved", label: "Saved" },
  { href: "/preview/dashboard/my-gear", label: "My gear" },
  { href: "/preview/dashboard/my-recipes", label: "My recipes" },
  { href: "/preview/dashboard/notifications", label: "Notifications" },
  { href: "/preview/dashboard/settings", label: "Settings" },
] as const;
    ...
    <div className="container">
      <div className="dashboard-page">
        ...
        <header className="dashboard-identity">
          ...
          {!user && !loading && (
            <Link href="/preview/login" className="hero-cta hero-cta-primary dashboard-signin">
              Sign in
            </Link>
          )}
        </header>
          ...
          <aside className="dashboard-sidebar" aria-label="Account navigation">
            <ul className="dept-list">
              ...
              {isAdmin && (
                <li>
                  <Link
                    href="/preview/dashboard/admin"
                    className={`dept-link dashboard-nav-link dashboard-nav-admin ${
                      pathname.startsWith("/preview/dashboard/admin") ? "is-active" : ""
                    }`}
                  >
