...
export const metadata: Metadata = {
  title: {
    absolute: "Fader & Knob v3 — Guitar Tone Recipes for Every Platform",
  },
  description:
...
export default function HomeV3() {
  ...
  return (
    <>
      {/* 1 — Orbital hero. The signal IS the background. */}
      <HeroV3 />

      {/* 2 — Signal chain showcase (retained — readers who want the
            detailed chain explanation can scroll for it). */}
      <SignalChainShowcase />
