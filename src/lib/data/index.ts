...
export const toneRecipes: ToneRecipe[] = [
      ...
      helix: {
        chain_blocks: [
          ...
          },
          {
            ...
            settings: { Decay: 1.0, Mix: 15 },
            notes: "Very subtle room reverb for studio ambience. Keep the mix low to preserve the dry, direct brown sound character.",
          },
        ],
        notes:
          "The Sag parameter on Helix amp models is the key to the brown sound. Add subtle room reverb for studio dimension. Use a bridge humbucker for authenticity.",
      },
      quad_cortex: {
        chain_blocks: [
          {
  ...
  // ---- John Mayer - Slow Dancing in a Burning Room ----
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          {
            ...
            settings: { Level: 6.0, Threshold: -18, Ratio: 3 },
        ...
        notes:
          "The Deluxe Comp before the Tube Screamer provides the always-on transparent compression Mayer uses. The Derailed Ingrid responds beautifully to pick dynamics. Use the neck pickup for leads.",
      },
      quad_cortex: {
        chain_blocks: [
          {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          {
            position: 1,
            block_name: "LA Studio Comp",
            block_category: "Dynamics",
            original_gear: "MXR Dyna Comp / studio LA-2A",
            settings: { Level: 6.0, "Peak Reduction": 30 },
            notes: "Light compression evens out the dynamics of fingerpicked notes. Keep it transparent and subtle.",
          },
          {
            position: 2,
            block_name: "US Deluxe Vib",
        ...
        notes:
          "Light compression before the clean amp evens out fingerpicked dynamics. Use your fingers instead of a pick, play on the neck pickup, and focus on dynamic control.",
      },
      quad_cortex: {
        chain_blocks: [
          {
        ...
        chain_blocks: [
          {
            ...
            settings: { Level: 6.0, "Peak Reduction": 25 },
        ...
        chain_blocks: [
          {
            ...
            settings: { Level: 6.0, Threshold: -18, Ratio: 4 },
            notes: "Light compression for added sustain and consistency on lead lines.",
          },
          {
            position: 2,
      ...
      helix: {
        chain_blocks: [
          ...
          },
          {
            ...
            settings: { Decay: 1.5, Mix: 18 },
            notes: "Subtle spring reverb adds the warm studio ambience of the Tres Hombres recording.",
          },
        ],
        notes:
          "Rangemaster into Plexi with spring reverb is the classic Billy Gibbons formula. Practice pinch harmonics for authentic ZZ Top snarl.",
      },
      quad_cortex: {
        chain_blocks: [
          {
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Soup Pro", block_category: "Amp", original_gear: "Supro Thunderbolt", settings: { Drive: 3.5, Bass: 5.0, Mid: 6.0, Treble: 6.0, "Ch Vol": 5.0 }, notes: "Low gain for warm cleans. The Soup Pro model captures the Supro's compressed clean character." },
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Minotaur", block_category: "Distortion", original_gear: "Klon Centaur", settings: { Drive: 1.0, Tone: 5.0, Level: 6.0 }, notes: "Klon-style transparent boost. Keep drive minimal." },
          { position: 2, block_name: "Derailed Ingrid", block_category: "Amp", original_gear: "Two Rock Custom Reverb", settings: { Drive: 4.0, Bass: 5.0, Mid: 5.0, Treble: 6.0, Presence: 5.0, "Ch Vol": 6.0 }, notes: "Clean Two Rock model. Very touch-sensitive and dynamic." },
          { position: 3, block_name: "2x12 Double C12N", block_category: "Cab", original_gear: "Two Rock 2x12", settings: { Mic: "57 Dynamic", Distance: 3.0 }, notes: "Open, airy cab sim for clean tone." },
        ],
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Triangle Fuzz", block_category: "Distortion", original_gear: "Fuzz pedal", settings: { Sustain: 6.0, Tone: 4.0, Level: 6.0 }, notes: "Dark fuzz with tone rolled back." },
          { position: 2, block_name: "Essex A30", block_category: "Amp", original_gear: "Vox AC30", settings: { Drive: 5.0, Bass: 6.0, Mid: 5.0, Treble: 4.0, "Ch Vol": 6.0, Cut: 3.0 }, notes: "AC30 with treble rolled back for a darker character." },
          { position: 3, block_name: "2x12 Blue Bell", block_category: "Cab", original_gear: "Vox 2x12 Alnico Blue", settings: { Mic: "57 Dynamic", Distance: 2.0 }, notes: "Alnico Blue cab for warm compression." },
        ],
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Scream 808", block_category: "Distortion", original_gear: "Tube Screamer", settings: { Drive: 0, Tone: 5.0, Level: 8.0 }, notes: "Clean boost to tighten the Mesa's low end." },
          { position: 2, block_name: "Cali IV Lead", block_category: "Amp", original_gear: "Mesa Mark IV", settings: { Drive: 7.0, Bass: 3.0, Mid: 3.0, Treble: 7.0, Presence: 6.0, "Ch Vol": 7.0 }, notes: "Scooped mids, tight bass. The classic Metallica Black Album rhythm tone." },
          { position: 3, block_name: "4x12 XXL V30", block_category: "Cab", original_gear: "Mesa Rectifier 4x12", settings: { Mic: "57 Dynamic", Distance: 1.0 }, notes: "V30 cab for tight, focused metal tone." },
        ],
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Das Benzin Lead", block_category: "Amp", original_gear: "Diezel VH4", settings: { Drive: 7.0, Bass: 6.0, Mid: 7.0, Treble: 5.0, Presence: 5.0, "Ch Vol": 7.0 }, notes: "Diezel model for thick, dark high-gain tone." },
          { position: 2, block_name: "4x12 XXL V30", block_category: "Cab", original_gear: "Mesa/Marshall 4x12", settings: { Mic: "57 Dynamic", Distance: 1.5 }, notes: "V30 cab for tight, modern metal tone." },
        ],
  ...
  },
  {
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "US Small Tweed", block_category: "Amp", original_gear: "Fender Champ", settings: { Drive: 10.0, Bass: 5.0, Mid: 6.0, Treble: 5.0, "Ch Vol": 8.0 }, notes: "Tiny Tweed amp model cranked for natural breakup. All the dirt comes from the amp." },
          { position: 2, block_name: "1x8 Small Tweed", block_category: "Cab", original_gear: "Champ 1x8", settings: { Mic: "57 Dynamic", Distance: 1.0 }, notes: "Small speaker cab for compressed, lo-fi character." },
        ],
