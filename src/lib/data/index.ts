      ...
      helix: {
        chain_blocks: [
          ...
          },
          {
            ...
            settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 },
            notes:
      ...
      helix: {
        chain_blocks: [
          ...
          },
          {
            ...
            enabled: true,
            settings: { Fuzz: 0.78, Level: 0.70, Tone: 0.62 },
            notes:
              "DEFAULT-ON drive — this is THE solo tone. Helix's Triangle Fuzz models the '69 Triangle Big Muff; the Ram's Head ('73-'77) is darker and slightly less aggressive but the Triangle is the closest stock option. Tone slightly above noon (0.62) keeps the famous Muff scoop from going boxy. Sustain (Fuzz) high but not maxed — past 0.85 it starts to spit.",
          },
          {
            position: 4,
          ...
          },
          {
            ...
            settings: { Time: 0.440, Feedback: 0.45, Mix: 0.30, Wow: 0.20, Flutter: 0.15, Drive: 0.30, Bass: 0.50, Treble: 0.45, HeadcaseSelect: 4 },
            notes:
              "Placed AFTER the cab so repeats stay clean — non-negotiable for this tone. 440ms with Feedback=0.45 gives the ~4 audible repeats that fill the gaps in the solo phrasing. Transistor Tape (vs. Cosmos Echo) has the slightly degraded, warm character of an Echorec; Wow/Flutter at 0.20/0.15 adds the tape-style movement without going seasick.",
          },
          {
            position: 9,
            block_name: "Plate",
            ...
            settings: { Decay: 0.43, Predelay: 0.07, Mix: 0.23, LowCut: 125, HighCut: 6500 },
            notes:
              "Plate is the workhorse for Gilmour — adds the room without the wash. Mix=0.23 is subtle on purpose; LowCut=125 keeps the low end tight under the Muff, HighCut=6500 keeps the tail from getting fizzy. Predelay=0.07 lets the dry note speak before the reverb tail blooms.",
          },
        ],
        notes:
      ...
      helix: {
        chain_blocks: [
          ...
          },
          {
            ...
            settings: { MicA: 0, PositionA: 0.35, MicB: 6, PositionB: 0.4, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 },
            notes: "Dual cab matching the original U87 + SM57 studio blend. MicB 6 (67 Condenser) is Helix's U87 equivalent.",
          },
        ],
        notes:
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12 Greenback", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Close-miked Greenback for tight, punchy midrange." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "1x12 Field Coil", block_category: "Cab", original_gear: "Supro 1x15", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Closest match to the Supro's warm, round speaker character." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 6, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "WEM 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Greenback cab as a close approximation to WEM Fane speakers." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Close-miked for maximum attack." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Close-miked Greenback for tight attack." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "2x12 Double C12N", block_category: "Cab", original_gear: "Two Rock 2x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Open, airy cab sim for clean tone." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "1x12 US Deluxe", block_category: "Cab", original_gear: "Fender 1x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Standard Fender 1x12 cab." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "2x12 Blue Bell", block_category: "Cab", original_gear: "Vox 2x12 Alnico Blue", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Alnico Blue cab for warm compression." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x12 Uber V30", block_category: "Cab", original_gear: "Mesa Rectifier 4x12", settings: { MicA: 0, PositionA: 0.27, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Uber (Rectifier) cab with 121 Ribbon mic off-center. Ribbon rolls off harsh fizz naturally so the 12kHz high-cut is gentle, not aggressive. Much more present than the old XXL/421/center-cone setup." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Close-miked for maximum presence." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x12 XXL V30", block_category: "Cab", original_gear: "Mesa/Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "V30 cab for tight, modern metal tone." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 6, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Standard Marshall cab." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "1x8 Small Tweed", block_category: "Cab", original_gear: "Champ 1x8", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Small speaker cab for compressed, lo-fi character." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x10 Tweed P10R", block_category: "Cab", original_gear: "Fender 3x10", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Multi-speaker Fender cab for full tone." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Marshall cab for midrange presence." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "4x12 XXL V30", block_category: "Cab", original_gear: "Mesa 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "V30 cab for tight metal tone." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x10 Tweed P10R", block_category: "Cab", original_gear: "Ampeg 4x10", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "4x10 cab for even low-end distribution." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 5, block_name: "1x15 Ampeg B-15", block_category: "Cab", original_gear: "1x15 JBL", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Round 1x15 for fat tone." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 6, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "WEM 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Smooth cab tone for the atmospheric feel." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { MicA: 0, PositionA: 0.35, MicB: 10, PositionB: 0.3, Distance: 1, Angle: 0, LowCut: 80, HighCut: 12000, EarlyReflections: 0.6, Level: 0 }, notes: "Close-miked for maximum attack." },
        ],
