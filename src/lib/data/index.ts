    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "Cali 2C+ Lead", block_category: "Amp", original_gear: "Mesa Mark IIC+", settings: { Drive: 7.0, Bass: 4.0, Mid: 5.0, Treble: 6.0, Presence: 6.0, Master: 1, Bias: 0.5, BiasX: 0.5, Sag: 0.5, Hum: 0.5, Ripple: 0.5, "Ch Vol": 7.0 }, notes: "Mark IIC+ lead channel for the solo. Use a snapshot to switch to clean settings for the intro." },
          { position: 5, block_name: "4x12 XXL V30", block_category: "Cab", original_gear: "Mesa 4x12", settings: { Mic: 5, Distance: 1, Position: 0.49, Angle: 0, LowCut: 19.9, HighCut: 16000, Level: 0, Pan: 0.5, Delay: 0 }, notes: "V30 cab for tight metal tone." },
        ],
      ...
      katana: {
        chain_blocks: [
          ...
          { position: 2, block_name: "Lead", block_category: "Amp Type", original_gear: "Mesa Mark IIC+", settings: { Gain: 7, Volume: 7, Bass: 4, Middle: 5, Treble: 6, Presence: 6 }, notes: "Lead channel for the solo. Switch to Clean for the intro." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "US Deluxe Vib", block_category: "Amp", original_gear: "Fender Vibroverb", settings: { Drive: 6.5, Bass: 5.0, Mid: 5.0, Treble: 5.0, Master: 1, Bias: 0.5, BiasX: 0.5, Sag: 0.5, Hum: 0.5, Ripple: 0.5, "Ch Vol": 7.0 }, notes: "Warm Vibroverb tone with more reverb." },
          { position: 5, block_name: "1x15 Ampeg B-15", block_category: "Cab", original_gear: "1x15 JBL", settings: { Mic: 5, Distance: 1, Position: 0.49, Angle: 0, LowCut: 19.9, HighCut: 16000, Level: 0, Pan: 0.5, Delay: 0 }, notes: "Round 1x15 for fat tone." },
        ],
      ...
      katana: {
        chain_blocks: [
          ...
          { position: 2, block_name: "Crunch", block_category: "Amp Type", original_gear: "Fender Vibroverb", settings: { Gain: 6, Volume: 7, Bass: 5, Middle: 5, Treble: 5, Presence: 5 }, notes: "Warm Crunch channel with reverb for the dreamy Little Wing quality." },
        ],
    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          { position: 1, block_name: "Volume Pedal", block_category: "Volume/Pan", original_gear: "Volume pedal", settings: { "Pedal Position": 1.0 }, notes: "Expression pedal for real-time volume control." },
          { position: 2, block_name: "Deluxe Comp", block_category: "Compressor", original_gear: "Studio compressor", settings: { Threshold: -36, Ratio: 2, Knee: 6, Attack: 0.06, Release: 0.91, Mix: 0.74, Level: 0 }, notes: "Transparent compression for even dynamics. Adjust Threshold to taste." },
          { position: 3, block_name: "Brit Plexi Brt", block_category: "Amp", original_gear: "Marshall Super Lead 1959", settings: { Drive: 8.0, Bass: 4.0, Mid: 6.0, Treble: 8.0, Presence: 8.0, Master: 1, Bias: 0.5, BiasX: 0.5, Sag: 0.5, Hum: 0.5, Ripple: 0.5, "Ch Vol": 7.5 }, notes: "Cranked Plexi with bright, cutting EQ for tapping clarity." },
          { position: 4, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12", settings: { Mic: 5, Distance: 1, Position: 0.49, Angle: 0, LowCut: 19.9, HighCut: 16000, Level: 0, Pan: 0.5, Delay: 0 }, notes: "Close-miked for maximum attack." },
        ],
      ...
      katana: {
        chain_blocks: [
          { position: 1, block_name: "Brown", block_category: "Amp Type", original_gear: "Marshall Super Lead", settings: { Gain: 8, Volume: 7, Bass: 4, Middle: 6, Treble: 8, Presence: 8 }, notes: "Brown channel with bright EQ for tapping clarity and aggressive AC/DC crunch." },
        ],
