    ...
    platform_translations: {
      helix: {
        chain_blocks: [
          ...
          { position: 4, block_name: "4x12 Greenback 25", block_category: "Cab", original_gear: "Marshall 4x12 Greenback", settings: { Mic: 5, Position: 0.49, Distance: 1, Angle: 0, Pan: 0.5, LowCut: 19.9, HighCut: 16000, Level: 0, Delay: 0 }, notes: "Close-miked Greenback for tight, punchy midrange." },
        ],
